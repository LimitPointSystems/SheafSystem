#
# $RCSfile: FindHDF5.cmake,v $ $Revision: 1.13 $ $Date: 2013/02/21 19:50:24 $
#
#
    ...
    foreach( LANGUAGE ${HDF5_LANGUAGE_BINDINGS} )
        ...
        foreach( LIB ${HDF5_${LANGUAGE}_LIBRARY_NAMES} )
            if( UNIX AND HDF5_USE_STATIC_LIBRARIES )
                ...
                set( THIS_LIBRARY_SEARCH_DEBUG lib${LIB}d.a ${LIB} )
                set( THIS_LIBRARY_SEARCH_RELEASE lib${LIB}.a ${LIB} )
            else()
                set( THIS_LIBRARY_SEARCH_DEBUG ${LIB}d.lib )
                set( THIS_LIBRARY_SEARCH_RELEASE ${LIB}.lib )
            endif()
...
if(WIN32 AND NOT HDF5_LIBRARY_DIRS)
    if(HDF5_USE_STATIC_LIBRARIES)
        find_library(HDF5_STATIC_LIBRARY NAMES hdf5d
                     HINTS ${HDF5_ROOT}/lib)
        if(HDF5_STATIC_LIBRARY)
            get_filename_component(HDF5_LIBRARY_DIRS ${HDF5_STATIC_LIBRARY} PATH)
        endif()
   else() 
    ...
    # Construct the complete list of HDF5 libraries 
if(WIN32 AND ENABLE_STATIC_PREREQS)
    set(HDF5_LIBRARIES ${HDF5_STATIC_LIBRARY} )
elseif(WIN32 AND NOT ENABLE_STATIC_PREREQS)
    set(HDF5_LIBRARIES ${HDF5_DLL_LIBRARY} )
else()
...
#    message(STATUS "System is OTHER")
