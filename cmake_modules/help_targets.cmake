#
# $RCSfile: help_targets.cmake,v $ $Revision: 1.5 $ $Date: 2013/01/12 17:16:50 $
#
#
...
add_custom_target(help-cmake-options
    ...
    COMMAND ${CMAKE_COMMAND} -E echo "    "
    COMMAND ${CMAKE_COMMAND} -E echo "LPS_DOC_STATE:"
    COMMAND ${CMAKE_COMMAND} -E echo "    "         
    ...
    COMMAND ${CMAKE_COMMAND} -E echo "    " 
    COMMAND ${CMAKE_COMMAND} -E echo "        example: ./cmboot -DLPS_DOC_STATE=dev"
    COMMAND ${CMAKE_COMMAND} -E echo "        example -- from build directory: cmake -DLPS_DOC_STATE=dev .."        
    COMMAND ${CMAKE_COMMAND} -E echo "    "
    COMMAND ${CMAKE_COMMAND} -E echo "BUILD_BINDINGS:"
    COMMAND ${CMAKE_COMMAND} -E echo "    "         
    COMMAND ${CMAKE_COMMAND} -E echo "    Toggles bindings targets. "
    COMMAND ${CMAKE_COMMAND} -E echo "    " 
    COMMAND ${CMAKE_COMMAND} -E echo "    Type: boolean"         
    COMMAND ${CMAKE_COMMAND} -E echo "    "        
    COMMAND ${CMAKE_COMMAND} -E echo "    Default Value: OFF"
