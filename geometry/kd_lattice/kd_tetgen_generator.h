...
// $RCSfile: kd_tetgen_generator.h,v $ $Revision: 1.5 $ $Date: 2013/01/12 17:17:30 $

//
// Copyright (c) 2013 Limit Point Systems, Inc.
//

// Interface for class kd_tetgen_generator.

#ifndef KD_TETGEN_GENERATOR_H
#define KD_TETGEN_GENERATOR_H
...
///
class SHEAF_DLL_SPEC kd_tetgen_generator : public mesh_generator
{
  // ===========================================================================
  /// @name KD_TETGEN_GENERATOR FACET
  // ===========================================================================
  //@{
...
public:
  ...
  ///
  /// Scaling factor applied to coordinates before
  /// passing to tetgen mesher.
  ///
  const e3_lite& scale() const;
...
protected:
  ...
  ///
  /// The kd_lattice containing the model.
  ///
  kd_lattice* _host;
...
public:
  ...
  ///
  virtual kd_tetgen_generator* clone() const;
...
#endif // ifndef KD_TETGEN_GENERATOR_H
