...
if(WIN64INTEL OR WIN64MSVC)
    ...
    set(${COMPONENT}_DEBUG_IMPORT_LIBS ${FIBER_BUNDLES_DEBUG_IMPORT_LIBS} ${${COMPONENT}_DEBUG_IMPORT_LIB}  CACHE STRING " Cumulative debug import libraries (win32) for ${PROJECT_NAME}" FORCE)    
...
function(add_library_targets)
    ...
    if(${USE_VTK})
     ...
     if(WIN64INTEL OR WIN64MSVC)
        ...
        if(${USE_VTK})
            target_link_libraries(${${COMPONENT}_DYNAMIC_LIB} ${VTK_LIBS} debug ${FIBER_BUNDLES_DEBUG_IMPORT_LIBS} optimized ${FIBER_BUNDLES_IMPORT_LIBS} )
            target_link_libraries(${${COMPONENT}_DYNAMIC_LIB} LINK_PRIVATE ${TETGEN_LIB})           
        else()
            target_link_libraries(${${COMPONENT}_DYNAMIC_LIB} debug ${FIBER_BUNDLES_DEBUG_IMPORT_LIBS} optimized ${FIBER_BUNDLES_IMPORT_LIBS})        
            target_link_libraries(${${COMPONENT}_DYNAMIC_LIB} LINK_PRIVATE ${TETGEN_LIB})
        endif() 
