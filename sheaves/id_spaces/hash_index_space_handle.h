...
#ifndef HASH_INDEX_SPACE_HANDLE_H
...
///
/// An hash map implementation of class scattered_insertion_index_space_handle.
...
///
class SHEAF_DLL_SPEC hash_index_space_handle : public scattered_insertion_index_space_handle
{
