// $RCSfile: singleton_index_space_interval.h,v $ $Revision: 1.3 $ $Date: 2013/03/13 00:59:03 $
...
/// @file
/// Interface for class singleton_index_space_interval

#ifndef SINGLETON_INDEX_SPACE_INTERVAL_H
#define SINGLETON_INDEX_SPACE_INTERVAL_H
...
/// by an offset.
///
class SHEAF_DLL_SPEC singleton_index_space_interval : public index_space_interval
{
...
protected:
  ...
  /// Assignment operator
  ///
  virtual singleton_index_space_interval& operator=(const index_space_collection& xother);
...
protected:
  ...
  /// The iterator pool.
  ///
  mutable list_pool<singleton_implicit_index_space_iterator> _iterators;
...
///
/// The deep size of singleton_index_space_interval& xn.
///
SHEAF_DLL_SPEC 
size_t deep_size(const singleton_index_space_interval& xn, bool xinclude_shallow = true);
  
} // end namespace sheaf

#endif // ifndef SINGLETON_INDEX_SPACE_INTERVAL_H
