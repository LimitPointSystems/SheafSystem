// $RCSfile: constant_implicit_index_space_iterator.h,v $ $Revision: 1.3 $ $Date: 2013/01/15 22:23:44 $
...
/// @file
/// Interface for class constant_implicit_index_space_iterator

#ifndef CONSTANT_IMPLICIT_INDEX_SPACE_ITERATOR_H
#define CONSTANT_IMPLICIT_INDEX_SPACE_ITERATOR_H
...
/// space in an constant_index_space_interval.
///
class SHEAF_DLL_SPEC constant_implicit_index_space_iterator : public implicit_index_space_iterator
{

  friend class constant_implicit_index_space_interval;

  // ===========================================================
  /// @name CONSTANT_IMPLICIT_INDEX_SPACE_ITERATOR FACET
  // ===========================================================
  //@{
...
public:
  ...
  /// Assignment operator.
  ///
  virtual constant_implicit_index_space_iterator& operator=(const index_space_iterator& xother);
...
#endif // ifndef CONSTANT_IMPLICIT_INDEX_SPACE_ITERATOR_H
