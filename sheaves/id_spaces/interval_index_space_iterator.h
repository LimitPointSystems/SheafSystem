// $RCSfile: interval_index_space_iterator.h,v $ $Revision: 1.3 $ $Date: 2013/01/15 22:23:44 $
...
#ifndef INTERVAL_INDEX_SPACE_ITERATOR_H
#define INTERVAL_INDEX_SPACE_ITERATOR_H
