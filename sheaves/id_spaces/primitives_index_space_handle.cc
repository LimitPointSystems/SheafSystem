...
sheaf::primitives_index_space_handle&
sheaf::primitives_index_space_handle::
operator=(const primitives_index_space_handle& xother)
{
  // Preconditions:
...
state()
{
  ...
  primitives_index_space_state& result =
    reinterpret_cast<primitives_index_space_state&>(*_state);
...
const sheaf::primitives_index_space_state&
sheaf::primitives_index_space_handle::
state() const
{
  // Preconditions:
  ...
  const primitives_index_space_state& result =
    reinterpret_cast<const primitives_index_space_state&>(*_state);
...
clone() const
{
  ...
  primitives_index_space_handle* result = new primitives_index_space_handle(*this);
		  ...
		  pod_type xlocal_id) const
{
  ...
  bool result =
    (dynamic_cast<primitives_index_space_state*>(state(xhost, xlocal_id)) != 0);
...
is_ancestor_of(const any *other) const
{
  ...
  bool result = dynamic_cast<const primitives_index_space_handle*>(other) != 0;
