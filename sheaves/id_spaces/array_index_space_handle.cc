...
/// @file
/// Implementation for class array_index_space_handle
	  ...
	  size_type xcapacity)
{
  ...
  array_index_space_handle result =
    array_index_space_state::new_space(xid_spaces,
				       xname,
				       xis_persistent,
				       xcapacity);
...
// ===========================================================
// ARRAY_INDEX_SPACE_HANDLE FACET
// ===========================================================
...
sheaf::array_index_space_handle&
sheaf::array_index_space_handle::
operator=(const array_index_space_handle& xother)
{
  // Preconditions:
    
  // Body:
  
  (void) mutable_index_space_handle::operator=(xother);
...
state()
{
  ...
  array_index_space_state& result =
    reinterpret_cast<array_index_space_state&>(*_state);
...
const sheaf::array_index_space_state&
sheaf::array_index_space_handle::
state() const
{
  // Preconditions:
  ...
  const array_index_space_state& result =
    reinterpret_cast<const array_index_space_state&>(*_state);
...
clone() const
{
  ...
  array_index_space_handle* result = new array_index_space_handle(*this);
		  ...
		  pod_type xlocal_id) const
{
  ...
  bool result =
    (dynamic_cast<array_index_space_state*>(state(xhost, xlocal_id)) != 0);
...
is_ancestor_of(const any *other) const
{
  ...
  bool result = dynamic_cast<const array_index_space_handle*>(other) != 0;
