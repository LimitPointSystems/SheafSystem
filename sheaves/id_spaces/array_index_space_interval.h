// $RCSfile: array_index_space_interval.h,v $ $Revision: 1.3 $ $Date: 2013/03/13 00:59:01 $
...
public:
  ...
  ///
  static arg_list make_arg_list(block<pod_type>& xhub_ids,
...
public:
  ...
  ///
  virtual array_index_space_interval* clone(const arg_list& xargs) const;
