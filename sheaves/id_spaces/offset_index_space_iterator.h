// $RCSfile: offset_index_space_iterator.h,v $ $Revision: 1.3 $ $Date: 2013/01/15 22:23:44 $
...
/// @file
/// Interface for class offset_index_space_iterator

#ifndef OFFSET_INDEX_SPACE_ITERATOR_H
#define OFFSET_INDEX_SPACE_ITERATOR_H
...
///
class SHEAF_DLL_SPEC offset_index_space_iterator : public explicit_index_space_iterator
{

  friend class offset_index_space_state;

  // ===========================================================
  /// @name OFFSET_INDEX_SPACE_ITERATOR FACET
  // ===========================================================
  //@{
...
public:
  ...
  /// Assignment operator.
  ///
  offset_index_space_iterator& operator=(const offset_index_space_iterator& xother);
...
public:
  ...
  /// Assignment operator.
  ///
  virtual offset_index_space_iterator& operator=(const index_space_iterator& xother);
  ...
  ///
  virtual offset_index_space_iterator* clone() const;
...
#endif // ifndef OFFSET_INDEX_SPACE_ITERATOR_H
