// $RCSfile: array_index_space_state.cc,v $ $Revision: 1.3 $ $Date: 2013/03/13 00:59:01 $
...
sheaf::array_index_space_state::
array_index_space_state(const arg_list& xargs)
...
clone(const arg_list& xargs) const
{
  ...
  array_index_space_state* result = new array_index_space_state(xargs);
