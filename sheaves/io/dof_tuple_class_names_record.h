// $RCSfile: dof_tuple_class_names_record.h,v $ $Revision: 1.11 $ $Date: 2013/01/12 17:17:35 $

//
// Copyright (c) 2013 Limit Point Systems, Inc.
//

// Interface for class dof_tuple_class_names_record

#ifndef DOF_TUPLE_CLASS_NAMES_RECORD_H
#define DOF_TUPLE_CLASS_NAMES_RECORD_H
...
///
/// A wrapper/adapter for the dof tuple class names record.
/// Intended for transferring index-name map data
/// between the kernel and the i/o subsystem.
///
///
class SHEAF_DLL_SPEC dof_tuple_class_names_record : public attributes_record
{
public:
  ...
  /// Destructor
  ///
  virtual ~dof_tuple_class_names_record();
...
#endif // ifndef DOF_TUPLE_CLASS_NAMES_RECORD_H
