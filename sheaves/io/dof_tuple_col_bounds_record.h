// $RCSfile: dof_tuple_col_bounds_record.h,v $ $Revision: 1.11 $ $Date: 2013/01/12 17:17:35 $

//
// Copyright (c) 2013 Limit Point Systems, Inc.
//

// Interface for class dof_tuple_col_bounds_record

#ifndef DOF_TUPLE_COL_BOUNDS_RECORD_H
#define DOF_TUPLE_COL_BOUNDS_RECORD_H
...
///
/// A wrapper/adapter for the dof tuple column bounds record.
/// Intended for transferring index-bounds map data
/// between the kernel and the i/o subsystem.
///
///
class SHEAF_DLL_SPEC dof_tuple_col_bounds_record : public attributes_record
{
public:
...
#endif // ifndef DOF_TUPLE_COL_BOUNDS_RECORD_H
