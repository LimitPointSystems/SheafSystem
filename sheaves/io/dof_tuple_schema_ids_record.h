// $RCSfile: dof_tuple_schema_ids_record.h,v $ $Revision: 1.11 $ $Date: 2013/01/12 17:17:35 $

//
// Copyright (c) 2013 Limit Point Systems, Inc.
//

// Interface for class dof_tuple_schema_ids_record

#ifndef DOF_TUPLE_SCHEMA_IDS_RECORD_H
#define DOF_TUPLE_SCHEMA_IDS_RECORD_H
...
///
/// A wrapper/adapter for the dof tuple schema ids record.
/// Intended for transferring index-id map data
/// between the kernel and the i/o subsystem.
///
///
class SHEAF_DLL_SPEC dof_tuple_schema_ids_record : public attributes_record
{
public:
  ...
  /// Destructor
  ///
  virtual ~dof_tuple_schema_ids_record();
...
#endif // ifndef DOF_TUPLE_SCHEMA_IDS_RECORD_H
