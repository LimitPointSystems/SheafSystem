...
// ===========================================================
// HOST FACTORY FACET OF CLASS SEC_ST2_E2
// ===========================================================
...
new_host(namespace_type& xns, 
         ...
         bool xauto_access)
{
  // cout << endl << "Entering sec_st2_e2::new_host." << endl;
  ...
  // cout << "Leaving sec_st2_e2::new_host." << endl;
  return result;
}
              ...
              bool xauto_access)
{
  ...
  require(standard_host_is_available<sec_st2_e2>(xns, xbase_path, xrep_path, xsection_suffix, xfiber_suffix, xauto_access));
  require(fiber_type::standard_host_is_available<fiber_type>(xns, xfiber_suffix, xauto_access));
  require(schema_type::standard_host_is_available<sec_st2_e2>(xns, xbase_path, xrep_path, xfiber_suffix, xauto_access));

  // Body:

  poset_path lstd_path = standard_host_path<sec_st2_e2>(xbase_path, xrep_path, xsection_suffix, xfiber_suffix);
  ...
  else
  {
    ...
    poset_path lstd_schema_path = 
      schema_type::standard_member<sec_st2_e2>(xns, xbase_path, lrep_path, xfiber_suffix, xauto_access);
  ...
  ensure(result.path(true) == standard_host_path<sec_st2_e2>(xbase_path, xrep_path, xsection_suffix, xfiber_suffix));
  ensure(result.state_is_not_read_accessible());
  ensure(result.schema(true).path(xauto_access) == 
         schema_type::standard_member_path<sec_st2_e2>(xbase_path, xrep_path, xfiber_suffix));
...
//==============================================================================
// COM_LIMITPOINT_FIBER_BUNDLE_ST2_E2 FACET OF CLASS SEC_ST2_E2
//==============================================================================
...
fiber_bundle::sec_st2_e2::
sec_st2_e2(const sec_rep_space* xhost, const std::string& xname)
{
...
fiber_bundle::sec_st2_e2::
sec_st2_e2(const sec_rep_space_member* xother)
{
...
fiber_bundle::sec_st2_e2::
sec_st2_e2(sec_rep_space* xhost, section_dof_map* xdof_map, bool xauto_access)
{
...
fiber_bundle::sec_st2_e2&
fiber_bundle::sec_st2_e2::
operator=(const sec_st2_e2& xother)
{
  // Preconditions:
...
const fiber_bundle::sec_st2_e2::fiber_type&
fiber_bundle::sec_st2_e2::
...
//==============================================================================
// TUPLE FACET OF CLASS SEC_ST2_E2
//==============================================================================
...
//==============================================================================
// ABSTRACT POSET MEMBER FACET OF CLASS SEC_ST2_E2
//==============================================================================
...
static_class_name()
{
  ...
  static const string result("sec_st2_e2");
...
clone() const
{
  ...
  sec_st2_e2 *result = new sec_st2_e2();
...
is_ancestor_of(const any* xother) const
{
  ...
  bool result = dynamic_cast<const sec_st2_e2*>(xother) != 0;
...
namespace
{
  ...
  {
  public:
    void operator()(const st2_e2_lite& xl0, at0_lite& xlresult) const
    {
      vd_value_type lcomp;
...
determinant(const sec_st2_e2& x0, sec_at0& xresult, bool xauto_access)
{
  // Preconditions:
