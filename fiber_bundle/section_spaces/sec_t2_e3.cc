...
#include "ComLimitPoint/fiber_bundle/e3.impl.h"
...
// ===========================================================
// HOST FACTORY FACET OF CLASS SEC_T2_E3
// ===========================================================
...
new_host(namespace_type& xns, 
         ...
         bool xauto_access)
{
  // cout << endl << "Entering sec_t2_e3::new_host." << endl;
  ...
  // cout << "Leaving sec_t2_e3::new_host." << endl;
  return result;
}
              ...
              bool xauto_access)
{
  ...
  require(standard_host_is_available<sec_t2_e3>(xns, xbase_path, xrep_path, xsection_suffix, xfiber_suffix, xauto_access));
  require(fiber_type::standard_host_is_available<fiber_type>(xns, xfiber_suffix, xauto_access));
  require(schema_type::standard_host_is_available<sec_t2_e3>(xns, xbase_path, xrep_path, xfiber_suffix, xauto_access));

  // Body:

  poset_path lstd_path = standard_host_path<sec_t2_e3>(xbase_path, xrep_path, xsection_suffix, xfiber_suffix);
  ...
  else
  {
    ...
    poset_path lstd_schema_path = 
      schema_type::standard_member<sec_t2_e3>(xns, xbase_path, lrep_path, xfiber_suffix, xauto_access);
  ...
  ensure(result.path(true) == standard_host_path<sec_t2_e3>(xbase_path, xrep_path, xsection_suffix, xfiber_suffix));
  ensure(result.state_is_not_read_accessible());
  ensure(result.schema(true).path(xauto_access) == 
         schema_type::standard_member_path<sec_t2_e3>(xbase_path, xrep_path, xfiber_suffix));
...
//==============================================================================
// COM_LIMITPOINT_FIBER_BUNDLE_T2_E3 FACET OF CLASS SEC_T2_E3
//==============================================================================
...
fiber_bundle::sec_t2_e3::
sec_t2_e3(const sec_rep_space_member& xother)
{
...
fiber_bundle::sec_t2_e3::
sec_t2_e3(sec_rep_space* xhost, section_dof_map* xdof_map, bool xauto_access)
{
...
fiber_bundle::sec_t2_e3::
sec_t2_e3(const sec_rep_space* xhost, pod_index_type xhub_id)
{
  // Preconditions:
...
fiber_bundle::sec_t2_e3::
sec_t2_e3(const sec_rep_space* xhost, const scoped_index& xid)
{
  // Preconditions:
...
fiber_bundle::sec_t2_e3::
sec_t2_e3(const sec_rep_space* xhost, const std::string& xname)
{
...
fiber_bundle::sec_t2_e3::
sec_t2_e3(const namespace_poset* xnamespace,
...
fiber_bundle::sec_t2_e3&
fiber_bundle::sec_t2_e3::
operator=(const sec_t2_e3& xother)
{
  // Preconditions:
...
const fiber_bundle::sec_t2_e3::fiber_type&
fiber_bundle::sec_t2_e3::
...
//==============================================================================
// TUPLE FACET OF CLASS SEC_T2_E3
//==============================================================================
...
//==============================================================================
// ABSTRACT POSET MEMBER FACET OF CLASS SEC_T2_E3
//==============================================================================
...
static_class_name()
{
  ...
  static const string result("sec_t2_e3");
...
clone() const
{
  ...
  sec_t2_e3 *result = new sec_t2_e3();
...
is_ancestor_of(const any* xother) const
{
  ...
  bool result = dynamic_cast<const sec_t2_e3*>(xother) != 0;
