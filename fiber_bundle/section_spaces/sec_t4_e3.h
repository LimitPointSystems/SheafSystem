...
///
class SHEAF_DLL_SPEC sec_t4_e3 : public sec_t4
{

  // ===========================================================
  /// @name HOST FACTORY FACET OF CLASS SEC_T4_E3
  // ===========================================================
  //@{
...
public:
  ...
  ///
  /// Copy constructor; creates a new sec_t4_e3 handle
  ...
  ///
  /// Creates a new sec_t4_e3 handle attached to the member state with hub id
  /// xhub_id in xhost.
  ///
  sec_t4_e3(const sec_rep_space* xhost, pod_index_type xhub_id);

  ///
  /// Creates a new sec_t4_e3 handle attached to
  ...
  ///
  sec_t4_e3(const sec_rep_space* xhost, const std::string& xname);
  ...
  /// Assignment operator; synonym for attach_to_state(&xother).
  ///
  sec_t4_e3& operator=(const sec_t4_e3& xother);

  ///
  /// Assignment operator.
  ///
  sec_t4_e3& operator=(const t4_e3& xfiber);

  ///
  /// Assignment operator.
  ///
  sec_t4_e3& operator=(const t4_e3_lite& xfiber);
...
private:
  ...
  //============================================================================
  /// @name T4 FACET OF CLASS SEC_T4_E3
  //============================================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name TP FACET OF CLASS SEC_T4_E3
  //============================================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name VD FACET OF CLASS SEC_T4_E3
  //============================================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name TUPLE FACET OF CLASS SEC_T4_E3
  //============================================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name ABSTRACT POSET MEMBER FACET OF CLASS SEC_T4_E3
  //============================================================================
  //@{
...
public:
  ...
  ///
  inline sec_t4_e3* clone(bool xnew_state, bool xauto_access = true) const
  {
    return static_cast<sec_t4_e3*>(sec_tp::clone(xnew_state, xauto_access));
  }
...
private:
  ...
  //============================================================================
  /// @name ANY FACET OF CLASS SEC_T4_E3
  //============================================================================
  //@{
