...
#define COM_LIMITPOINT_FIBER_BUNDLE_SEC_E1_UNIFORM_H
...
{
  // ===========================================================
  /// @name HOST FACTORY FACET OF CLASS SEC_E1_UNIFORM
  // ===========================================================
  //@{
...
#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_SEC_E1_UNIFORM_H
