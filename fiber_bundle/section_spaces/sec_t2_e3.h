...
#define COM_LIMITPOINT_FIBER_BUNDLE_SEC_T2_E3_H
...
#ifndef COM_LIMITPOINT_FIBER_BUNDLE_T2_E3
...
private:
  ...
  //============================================================================
  /// @name COM_LIMITPOINT_FIBER_BUNDLE_T2_E3 FACET OF CLASS SEC_T2_E3
  //============================================================================
  //@{
...
public:
  ...
  ///
  /// Copy constructor; creates a new sec_t2_e3 handle
  ...
  ///
  /// Creates a new sec_t2_e3 handle attached to the member state with hub id
  /// xhub_id in xhost.
  ///
  sec_t2_e3(const sec_rep_space* xhost, pod_index_type xhub_id);

  ///
  /// Creates a new sec_t2_e3 handle attached to
  ...
  ///
  virtual sec_t2_e3& operator=(const abstract_poset_member& xother);

  ///
  /// Assignment operator; synonym for attach_to_state(&xother).
  ///
  sec_t2_e3& operator=(const sec_t2_e3& xother);

  ///
  /// Assignment operator.
  ///
  sec_t2_e3& operator=(const t2_e3& xfiber);

  ///
  /// Assignment operator.
  ///
  sec_t2_e3& operator=(const t2_e3_lite& xfiber);
...
private:
  ...
  //============================================================================
  /// @name T2 FACET OF CLASS SEC_T2_E3
  //============================================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name TP FACET OF CLASS SEC_T2_E3
  //============================================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name VD FACET OF CLASS SEC_T2_E3
  //============================================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name TUPLE FACET OF CLASS SEC_T2_E3
  //============================================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name ABSTRACT POSET MEMBER FACET OF CLASS SEC_T2_E3
  //============================================================================
  //@{
...
public:
  ...
  ///
  inline sec_t2_e3* clone(bool xnew_state, bool xauto_access = true) const
  {
    return static_cast<sec_t2_e3*>(sec_tp::clone(xnew_state, xauto_access));
  }
...
private:
  ...
  //============================================================================
  /// @name ANY FACET OF CLASS SEC_T2_E3
  //============================================================================
  //@{
...
#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_SEC_T2_E3_H
