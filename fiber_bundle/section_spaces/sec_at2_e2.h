...
#define COM_LIMITPOINT_FIBER_BUNDLE_SEC_AT2_E2_H

#ifndef COM_LIMITPOINT_SHEAF_SHEAF_DLL_SPEC_H
#include "ComLimitPoint/sheaf/sheaf_dll_spec.h"
#endif

#ifndef COM_LIMITPOINT_FIBER_BUNDLE_SEC_AT2_H
#include "ComLimitPoint/fiber_bundle/sec_at2.h"
#endif

#ifndef COM_LIMITPOINT_FIBER_BUNDLE_AT2_E2
...
///
class SHEAF_DLL_SPEC sec_at2_e2 : public sec_at2
{
  // ===========================================================
  /// @name HOST FACTORY FACET OF CLASS SEC_AT2_E2
  // ===========================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name COM_LIMITPOINT_FIBER_BUNDLE_AT2_E2 FACET OF CLASS SEC_AT2_E2
  //============================================================================
  //@{
...
public:
  ...
  ///
  /// Copy constructor; creates a new sec_at2_e2 handle
  ...
  /// Assignment operator; synonym for attach_to_state(&xother).
  ///
  sec_at2_e2& operator=(const sec_at2_e2& xother);

  ///
  /// Assignment operator.
  ///
  sec_at2_e2& operator=(const at2_e2& xfiber);

  ///
  /// Assignment operator.
  ///
  sec_at2_e2& operator=(const at2_e2_lite& xfiber);
  ...
  ///
  /// Creates a new sec_at2_e2 handle attached to the member state with hub id
  /// xhub_id in* xhost.
  ///
  sec_at2_e2(const sec_rep_space* xhost, pod_index_type xhub_id);

  ///
  /// Creates a new sec_at2_e2 handle attached to
  ...
  ///
  sec_at2_e2(const sec_rep_space* xhost, const std::string& xname);
...
private:
  ...
  //============================================================================
  /// @name AT2 FACET OF CLASS SEC_AT2_E2
  //============================================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name TP FACET OF CLASS SEC_AT2_E2
  //============================================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name VD FACET OF CLASS SEC_AT2_E2
  //============================================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name TUPLE FACET OF CLASS SEC_AT2_E2
  //============================================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name ABSTRACT POSET MEMBER FACET OF CLASS SEC_AT2_E2
  //============================================================================
  //@{
...
public:
  ...
  ///
  inline sec_at2_e2* clone(bool xnew_state, bool xauto_access = true) const
  {
    return static_cast<sec_at2_e2*>(sec_atp::clone(xnew_state, xauto_access));
  }
...
private:
  ...
  //============================================================================
  /// @name ANY FACET OF CLASS SEC_AT2_E2
  //============================================================================
  //@{
...
///
SHEAF_DLL_SPEC void hook(const sec_e2& x0, const sec_e2& x1, sec_at0& xresult,
			 bool xauto_access);
...
/// (pre-allocated version for persistent types).
///
SHEAF_DLL_SPEC void hook(const sec_at2_e2& x0, const sec_e2& x1, sec_e2& xresult,
			 bool xauto_access);
...
/// (pre-allocated version).
///
SHEAF_DLL_SPEC void wedge(const sec_e2& x0, const sec_e2& x1, sec_at2_e2& xresult,
			  bool xauto_access);
...
#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_SEC_AT2_E2_H
