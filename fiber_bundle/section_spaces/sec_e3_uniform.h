...
#define COM_LIMITPOINT_FIBER_BUNDLE_SEC_E3_UNIFORM_H
...
{
  // ===========================================================
  /// @name HOST FACTORY FACET OF CLASS SEC_E3_UNIFORM
  // ===========================================================
  //@{
...
public:
  ...
  ///
  sec_e3_uniform(const sec_rep_space* xhost, const std::string& xname);
...
#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_SEC_E3_UNIFORM_H
