...
#define COM_LIMITPOINT_FIBER_BUNDLE_SEC_AT2_E3_H
...
#ifndef COM_LIMITPOINT_FIBER_BUNDLE_AT2_E3
...
///
class SHEAF_DLL_SPEC sec_at2_e3 : public sec_at2
{

  // ===========================================================
  /// @name HOST FACTORY FACET OF CLASS SEC_AT2_E3
  // ===========================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name COM_LIMITPOINT_FIBER_BUNDLE_AT2_E3 FACET OF CLASS SEC_AT2_E3
  //============================================================================
  //@{
...
public:
  ...
  ///
  /// Copy constructor; creates a new sec_at2_e3 handle
  ...
  ///
  /// Creates a new sec_at2_e3 handle attached to the member state with hub id
  /// xhub_id in* xhost.
  ///
  sec_at2_e3(const sec_rep_space* xhost, pod_index_type xhub_id);

  ///
  /// Creates a new sec_at2_e3 handle attached to
  ...
  /// Assignment operator; synonym for attach_to_state(&xother).
  ///
  sec_at2_e3& operator=(const sec_at2_e3& xother);

  ///
  /// Assignment operator.
  ///
  sec_at2_e3& operator=(const at2_e3& xfiber);

  ///
  /// Assignment operator.
  ///
  sec_at2_e3& operator=(const at2_e3_lite& xfiber);
...
private:
  ...
  //============================================================================
  /// @name AT2 FACET OF CLASS SEC_AT2_E3
  //============================================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name ATP FACET OF CLASS SEC_AT2_E3
  //============================================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name TP FACET OF CLASS SEC_AT2_E3
  //============================================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name VD FACET OF CLASS SEC_AT2_E3
  //============================================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name TUPLE FACET OF CLASS SEC_AT2_E3
  //============================================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name ABSTRACT POSET MEMBER FACET OF CLASS SEC_AT2_E3
  //============================================================================
  //@{
...
public:
  ...
  ///
  inline sec_at2_e3* clone(bool xnew_state, bool xauto_access = true) const
  {
    return static_cast<sec_at2_e3*>(sec_atp::clone(xnew_state, xauto_access));
  }
...
private:
  ...
  //============================================================================
  /// @name ANY FACET OF CLASS SEC_AT2_E3
  //============================================================================
  //@{
...
///
SHEAF_DLL_SPEC void hook(const sec_e3& x0, const sec_e3& x1, sec_at0& xresult,
			 bool xauto_access);
...
/// (pre-allocated version for persistent types).
///
SHEAF_DLL_SPEC void hook(const sec_at2_e3& x0, const sec_e3& x1, sec_e3& xresult,
			 bool xauto_access);
...
/// (pre-allocated version).
///
SHEAF_DLL_SPEC void wedge(const sec_e3& x0, const sec_e3& x1, sec_at2_e3& xresult,
			  bool xauto_access);
...
#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_SEC_AT2_E3_H
