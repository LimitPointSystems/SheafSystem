...
// ===========================================================
// HOST FACTORY FACET OF CLASS SEC_ST4_E2
// ===========================================================
...
new_host(namespace_type& xns, 
         ...
         bool xauto_access)
{
  // cout << endl << "Entering sec_st4_e2::new_host." << endl;
  ...
  // cout << "Leaving sec_st4_e2::new_host." << endl;
  return result;
}
              ...
              bool xauto_access)
{
  ...
  require(standard_host_is_available<sec_st4_e2>(xns, xbase_path, xrep_path, xsection_suffix, xfiber_suffix, xauto_access));
  require(fiber_type::standard_host_is_available<fiber_type>(xns, xfiber_suffix, xauto_access));
  require(schema_type::standard_host_is_available<sec_st4_e2>(xns, xbase_path, xrep_path, xfiber_suffix, xauto_access));

  // Body:

  poset_path lstd_path = standard_host_path<sec_st4_e2>(xbase_path, xrep_path, xsection_suffix, xfiber_suffix);
  ...
  else
  {
    ...
    poset_path lstd_schema_path = 
      schema_type::standard_member<sec_st4_e2>(xns, xbase_path, lrep_path, xfiber_suffix, xauto_access);
  ...
  ensure(result.path(true) == standard_host_path<sec_st4_e2>(xbase_path, xrep_path, xsection_suffix, xfiber_suffix));
  ensure(result.state_is_not_read_accessible());
  ensure(result.schema(true).path(xauto_access) == 
         schema_type::standard_member_path<sec_st4_e2>(xbase_path, xrep_path, xfiber_suffix));
...
//==============================================================================
// COM_LIMITPOINT_FIBER_BUNDLE_ST4_E2 FACET OF CLASS SEC_ST4_E2
//==============================================================================
