...
#define COM_LIMITPOINT_FIBER_BUNDLE_SEC_AT2_H
...
class SHEAF_DLL_SPEC sec_at2 : public sec_atp
{
  ...
  // ===========================================================
  /// @name HOST_FACTORY FACET OF CLASS SEC_AT2
  // ===========================================================
  //@{
...
public:
  ...
  /// xname in xhost.
  ///
  sec_at2(const sec_rep_space* xhost, const std::string& xname);
...
#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_SEC_AT2_H
