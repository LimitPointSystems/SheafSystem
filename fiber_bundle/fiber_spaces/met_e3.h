...
#define COM_LIMITPOINT_FIBER_BUNDLE_MET_E3_H
...
class SHEAF_DLL_SPEC met_e3 : public met_ed
{
  ...
  // ===========================================================
  /// @name HOST FACTORY FACET OF CLASS MET_E3
  // ===========================================================
  //@{
...
public:
  ...
  ///
  /// The host with path standard_host_path<met_e3>(xsuffix).
...
public:
  ...
  /// in xhost.
  ///
  met_e3(const poset_state_handle* xhost, const std::string& xname);
...
#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_MET_E3_H
