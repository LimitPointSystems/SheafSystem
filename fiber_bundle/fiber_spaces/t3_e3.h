...
#define COM_LIMITPOINT_FIBER_BUNDLE_T3_E3_H

#ifndef COM_LIMITPOINT_SHEAF_SHEAF_DLL_SPEC_H
#include "ComLimitPoint/sheaf/sheaf_dll_spec.h"
#endif

#ifndef COM_LIMITPOINT_FIBER_BUNDLE_T3_H
...
class SHEAF_DLL_SPEC t3_e3_lite : public t3_lite
{
  ...
  //============================================================================
  /// @name COM_LIMITPOINT_FIBER_BUNDLE_T3_E3 FACET OF CLASS T3_E3_LITE
  //============================================================================
  //@{
...
class SHEAF_DLL_SPEC t3_e3 : public t3
{
  ...
  // ===========================================================
  /// @name HOST FACTORY FACET OF CLASS COM_LIMITPOINT_FIBER_BUNDLE_T3_E3
  // ===========================================================
  //@{
...
public:
  ...
  ///
  /// The host with path standard_host_path<t3_e3>(xsuffix).
...
private:
  ...
  //============================================================================
  /// @name COM_LIMITPOINT_FIBER_BUNDLE_T3_E3 FACET OF CLASS COM_LIMITPOINT_FIBER_BUNDLE_T3_E3
  //============================================================================
  //@{
...
public:
  ...
  //============================================================================
  /// @name T3 FACET OF CLASS COM_LIMITPOINT_FIBER_BUNDLE_T3_E3
  //============================================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name ST2 FACET OF CLASS COM_LIMITPOINT_FIBER_BUNDLE_T3_E3
  //============================================================================
...
private:
  ...
  //============================================================================
  /// @name STP FACET OF CLASS COM_LIMITPOINT_FIBER_BUNDLE_T3_E3
  //============================================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name TP FACET OF CLASS COM_LIMITPOINT_FIBER_BUNDLE_T3_E3
  //============================================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name VD FACET OF CLASS COM_LIMITPOINT_FIBER_BUNDLE_T3_E3
  //============================================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name TUPLE FACET OF CLASS COM_LIMITPOINT_FIBER_BUNDLE_T3_E3
  //============================================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name ABSTRACT POSET MEMBER FACET OF CLASS COM_LIMITPOINT_FIBER_BUNDLE_T3_E3
  //============================================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name ANY FACET OF CLASS COM_LIMITPOINT_FIBER_BUNDLE_T3_E3
  //============================================================================
  //@{
...
#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_T3_E3_H
