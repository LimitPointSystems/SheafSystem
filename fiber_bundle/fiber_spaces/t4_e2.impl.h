...
#ifndef COM_LIMITPOINT_FIBER_BUNDLE_T4_E2_IMPL_H
#define COM_LIMITPOINT_FIBER_BUNDLE_T4_E2_IMPL_H
...
static_class_name()
{
  ...
  static const std::string result("t4_e2_row_dofs_type");
...
t4_e2_row_dofs_type<T>::clone() const
{
  ...
  t4_e2_row_dofs_type<T>* result = new t4_e2_row_dofs_type<T>();
...
#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_T4_E2_IMPL_H
