...
#ifndef COM_LIMITPOINT_FIBER_BUNDLE_JCB_E13_H
#define COM_LIMITPOINT_FIBER_BUNDLE_JCB_E13_H
...
public:
  ...
  ///
  /// The host with path standard_host_path<jcb_e13>(xsuffix).
...
#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_JCB_E13_H
