...
#ifndef COM_LIMITPOINT_FIBER_BUNDLE_MET_E1_IMPL_H
#define COM_LIMITPOINT_FIBER_BUNDLE_MET_E1_IMPL_H
...
static_class_name()
{
  ...
  static const std::string result("met_e1_row_dofs_type");
...
#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_MET_E1_IMPL_H
