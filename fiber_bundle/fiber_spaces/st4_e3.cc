...
#include "ComLimitPoint/fiber_bundle/st4_e3.impl.h"
...
//==============================================================================
// COM_LIMITPOINT_FIBER_BUNDLE_ST4_E3 FACET
//==============================================================================
...
// ===========================================================
// HOST FACTORY FACET OF CLASS COM_LIMITPOINT_FIBER_BUNDLE_ST4_E3
// ===========================================================
...
new_host(namespace_type& xns, 
         ...
         bool xauto_access)
{
  // cout << endl << "Entering st4_e3::new_host." << endl;
  ...
  require(schema_poset_member::row_dof_ct(xns, xschema_path, xauto_access) == 15);
  ...
  ensure(result.factor_ct(true) == 15);
  ensure(result.d(true) == 15);
  ...
  // cout << "Leaving st4_e3::new_host." << endl;
  return result;
}
...
standard_host(namespace_type& xns, const std::string& xsuffix, bool xauto_access)
{
  ...
  require(standard_host_is_available<st4_e3>(xns, xsuffix, xauto_access));
  ...
  poset_path lpath(standard_host_path<st4_e3>(xsuffix));
  ...
  ensure(result.path(true) == standard_host_path<st4_e3>(xsuffix));
  ensure(result.state_is_not_read_accessible());
