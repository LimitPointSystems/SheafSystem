...
#ifndef COM_LIMITPOINT_FIBER_BUNDLE_AT2_E2_IMPL_H
#define COM_LIMITPOINT_FIBER_BUNDLE_AT2_E2_IMPL_H
...
static_class_name()
{
  ...
  static const std::string result("at2_e2_row_dofs_type");
...
#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_AT2_E2_IMPL_H
