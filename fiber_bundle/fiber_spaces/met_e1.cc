...
#include "ComLimitPoint/fiber_bundle/met_e1.impl.h"
...
// ===========================================================
// HOST FACTORY FACET OF CLASS MET_E1
// ===========================================================
         ...
         bool xauto_access)
{
  ...
  require(xns.member_poset<vector_space_type::host_type>(xvector_space_path, xauto_access).d(xauto_access) == 1);
  ...
  // cout << "Leaving met_e1::new_host." << endl;
  return result;
}
...
standard_host(namespace_type& xns, const std::string& xsuffix, bool xauto_access)
{
  ...
  require(standard_host_is_available<met_e1>(xns, xsuffix, xauto_access));
  ...
  poset_path lpath(standard_host_path<met_e1>(xsuffix));
  ...
  ensure(result.path(true) == standard_host_path<met_e1>(xsuffix));
  ensure(result.state_is_not_read_accessible());
