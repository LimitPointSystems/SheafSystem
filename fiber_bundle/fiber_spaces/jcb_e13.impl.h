...
#ifndef COM_LIMITPOINT_FIBER_BUNDLE_JCB_E13_IMPL_H
#define COM_LIMITPOINT_FIBER_BUNDLE_JCB_E13_IMPL_H
...
static_class_name()
{
  ...
  static const std::string result("jcb_e13_row_dofs_type");
...
#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_JCB_E13_IMPL_H
