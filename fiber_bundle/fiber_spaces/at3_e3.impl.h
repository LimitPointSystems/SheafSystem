...
#ifndef COM_LIMITPOINT_FIBER_BUNDLE_AT3_E3_IMPL_H
#define COM_LIMITPOINT_FIBER_BUNDLE_AT3_E3_IMPL_H
...
static_class_name()
{
  ...
  static const std::string result("at3_e3_row_dofs_type");
...
#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_AT3_E3_IMPL_H
