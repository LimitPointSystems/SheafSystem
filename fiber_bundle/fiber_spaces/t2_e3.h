...
#ifndef COM_LIMITPOINT_FIBER_BUNDLE_T2_E3_H
#define COM_LIMITPOINT_FIBER_BUNDLE_T2_E3_H
...
#ifndef COM_LIMITPOINT_FIBER_BUNDLE_GENERAL_MATRIX_3X3_H
#include "ComLimitPoint/fiber_bundle/general_matrix_3x3.h"
#endif
...
class SHEAF_DLL_SPEC t2_e3_lite : public t2_lite
{
  ...
  //============================================================================
  /// @name COM_LIMITPOINT_FIBER_BUNDLE_T2_E3 FACET OF CLASS T2_E3_LITE
  //============================================================================
  //@{
...
class SHEAF_DLL_SPEC t2_e3 : public t2
{
  ...
  // ===========================================================
  /// @name HOST FACTORY FACET OF CLASS COM_LIMITPOINT_FIBER_BUNDLE_T2_E3
  // ===========================================================
  //@{
...
public:
  ...
  ///
  /// The host with path standard_host_path<t2_e3>(xsuffix).
...
private:
  ...
  //============================================================================
  /// @name COM_LIMITPOINT_FIBER_BUNDLE_T2_E3 FACET OF CLASS COM_LIMITPOINT_FIBER_BUNDLE_T2_E3
  //============================================================================
  //@{
...
public:
  ...
  //============================================================================
  /// @name T2 FACET OF CLASS COM_LIMITPOINT_FIBER_BUNDLE_T2_E3
  //============================================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name TP FACET OF CLASS COM_LIMITPOINT_FIBER_BUNDLE_T2_E3
  //============================================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name VD FACET OF CLASS COM_LIMITPOINT_FIBER_BUNDLE_T2_E3
  //============================================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name TUPLE FACET OF CLASS COM_LIMITPOINT_FIBER_BUNDLE_T2_E3
  //============================================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name ABSTRACT POSET MEMBER FACET OF CLASS COM_LIMITPOINT_FIBER_BUNDLE_T2_E3
  //============================================================================
  //@{
...
private:
  ...
  //============================================================================
  /// @name ANY FACET OF CLASS COM_LIMITPOINT_FIBER_BUNDLE_T2_E3
  //============================================================================
  //@{
...
#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_T2_E3_H
