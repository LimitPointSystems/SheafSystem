...
#ifndef COM_LIMITPOINT_FIBER_BUNDLE_T2_E3_IMPL_H
#define COM_LIMITPOINT_FIBER_BUNDLE_T2_E3_IMPL_H
...
static_class_name()
{
  ...
  static const std::string result("t2_e3_row_dofs_type");
...
#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_T2_E3_IMPL_H
