...
#include "ComLimitPoint/fiber_bundle/st4_e2.impl.h"
...
fiber_bundle::st4_e2_lite::
operator st4_e2_lite::row_dofs_type& ()
{
  // Preconditions:
...
fiber_bundle::st4_e2_lite::
operator const st4_e2_lite::row_dofs_type& () const
{
  // Preconditions:
...
static_class_name()
{
  ...
  static const string result("st4_e2_lite");
...
clone() const
{
  st4_e2_lite* result = 0;

  // Preconditions:

  // Body:

  result = new st4_e2_lite();
...
is_ancestor_of(const any_lite& xother) const
{
  ...
  bool result = dynamic_cast<const st4_e2_lite*>(&xother) != 0;
...
standard_schema_path()
{
  ...
  static const poset_path result(standard_schema_poset_name(), "st4_e2_schema");
...
new_host(namespace_type& xns, 
         ...
         bool xauto_access)
{
  // cout << endl << "Entering st4_e2::new_host." << endl;
  ...
  require(schema_poset_member::row_dof_ct(xns, xschema_path, xauto_access) == 5);
  ...
  ensure(result.factor_ct(true) == 5);
  ensure(result.d(true) == 5);
  ...
  // cout << "Leaving st4_e2::new_host." << endl;
  return result;
}
...
standard_host(namespace_type& xns, const std::string& xsuffix, bool xauto_access)
{
  ...
  require(standard_host_is_available<st4_e2>(xns, xsuffix, xauto_access));
  ...
  poset_path lpath(standard_host_path<st4_e2>(xsuffix));
  ...
  ensure(result.path(true) == standard_host_path<st4_e2>(xsuffix));
  ensure(result.state_is_not_read_accessible());
...
fiber_bundle::st4_e2::
st4_e2(abstract_poset_member* xother)
{
...
fiber_bundle::st4_e2::
st4_e2(poset_state_handle* xhost, bool xauto_access)
{
...
const fiber_bundle::st4_e2::volatile_type&
fiber_bundle::st4_e2::
...
///
fiber_bundle::st4_e2::volatile_type*
fiber_bundle::st4_e2::
lite_type() const
{
  // Preconditions:
...
fiber_bundle::st4_e2::
operator const st4_e2::row_dofs_type& () const
{
  // Preconditions:
...
static_class_name()
{
  ...
  static const string result("st4_e2");
