...
#ifndef COM_LIMITPOINT_FIBER_BUNDLE_JCB_E33_IMPL_H
#define COM_LIMITPOINT_FIBER_BUNDLE_JCB_E33_IMPL_H
...
static_class_name()
{
  ...
  static const std::string result("jcb_e33_row_dofs_type");
...
#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_JCB_E33_IMPL_H
