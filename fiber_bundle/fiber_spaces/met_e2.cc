...
#include "ComLimitPoint/fiber_bundle/met_e2.impl.h"
...
// ===========================================================
// HOST FACTORY FACET OF CLASS MET_E2
// ===========================================================
...
new_host(namespace_type& xns, 
         ...
         bool xauto_access)
{
  // cout << endl << "Entering met_e2::new_host." << endl;
  ...
  // cout << "Leaving met_e2::new_host." << endl;
  return result;
}
...
standard_host(namespace_type& xns, const std::string& xsuffix, bool xauto_access)
{
  ...
  require(standard_host_is_available<met_e2>(xns, xsuffix, xauto_access));
  ...
  poset_path lpath(standard_host_path<met_e2>(xsuffix));
  ...
  ensure(result.path(true) == standard_host_path<met_e2>(xsuffix));
  ensure(result.state_is_not_read_accessible());
