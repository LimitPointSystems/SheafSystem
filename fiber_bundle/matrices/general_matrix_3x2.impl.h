...
// Implementation for general_matrix_3x2.


#ifndef COM_LIMITPOINT_FIBER_BUNDLE_GENERAL_MATRIX_3X2_IMPL_H
#define COM_LIMITPOINT_FIBER_BUNDLE_GENERAL_MATRIX_3X2_IMPL_H
...
#include "ComLimitPoint/fiber_bundle/general_matrix_3x1.h"
#endif

#ifndef COM_LIMITPOINT_FIBER_BUNDLE_GENERAL_MATRIX_3X2_H
#include "ComLimitPoint/fiber_bundle/general_matrix_3x2.h"
#endif
...
operator jcb_e23_row_dofs_type<T>& () const
{
  ...
  jcb_e23_row_dofs_type<T>& result =
    reinterpret_cast<jcb_e23_row_dofs_type<T>&>(*lcomps);
...
operator T* ()
{
  ...
  //cout << "general_matrix_3x2<T>::operator T* () " << std::endl;
...
operator const T* () const
{
  ...
  //cout << "general_matrix_3x2<T>::operator const T* () const " << std::endl;
...
void 
general_matrix_3x2<T>::
multiply(const T& xscalar, general_matrix_3x2<T>& xresult) const
{
  // Preconditions:
         ...
         general_matrix_3x3<T>& xresult) const
{
  ...
  const general_matrix_3x2<T>& lm = *this;
...
void
general_matrix_3x2<T>::
transpose(general_matrix_2x3<T>& xresult) const
{
  // Preconditions:
...
#endif // COM_LIMITPOINT_FIBER_BUNDLE_GENERAL_MATRIX_3X2_IMPL_H
