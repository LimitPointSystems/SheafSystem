...
#ifndef COM_LIMITPOINT_FIBER_BUNDLE_GENERAL_MATRIX_1X2_IMPL_H
#define COM_LIMITPOINT_FIBER_BUNDLE_GENERAL_MATRIX_1X2_IMPL_H
...
operator T* ()
{
  ...
  //cout << "general_matrix_1x2<T>::operator T* () " << std::endl;
...
operator const T* () const
{
  ...
  //cout << "general_matrix_1x2<T>::operator const T* () const " << std::endl;
...
#endif // COM_LIMITPOINT_FIBER_BUNDLE_GENERAL_MATRIX_1X2_IMPL_H
