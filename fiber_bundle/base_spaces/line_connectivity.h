...
#ifndef COM_LIMITPOINT_FIBER_BUNDLE_LINE_CONNECTIVITY_H
#define COM_LIMITPOINT_FIBER_BUNDLE_LINE_CONNECTIVITY_H
...
#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_LINE_CONNECTIVITY_H
