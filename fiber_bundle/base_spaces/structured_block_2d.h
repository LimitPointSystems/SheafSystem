...
// Interface for class STRUCTURED_Block_2d

#ifndef COM_LIMITPOINT_FIBER_BUNDLE_STRUCTURED_BLOCK_2D_H
#define COM_LIMITPOINT_FIBER_BUNDLE_STRUCTURED_BLOCK_2D_H

#ifndef COM_LIMITPOINT_SHEAF_SHEAF_DLL_SPEC_H
#include "ComLimitPoint/sheaf/sheaf_dll_spec.h"
#endif

#ifndef COM_LIMITPOINT_FIBER_BUNDLE_STRUCTURED_BLOCK_H
#include "ComLimitPoint/fiber_bundle/structured_block.h"
#endif

#ifndef COM_LIMITPOINT_FIBER_BUNDLE_STRUCTURED_BLOCK_2D_CRG_INTERVAL_H
#include "ComLimitPoint/fiber_bundle/structured_block_2d_crg_interval.h"
#endif
...
///
class SHEAF_DLL_SPEC structured_block_2d : public structured_block
{

  friend class structured_block_2d_crg_interval;
...
private:
  ...
  // ===========================================================
  /// @name STRUCTURED_BLOCK_2D FACET
  // ===========================================================
  //@{
...
public:
  ...
  ///
  /// Copy constructor; creates a new structured_block_2d handle.
  ...
  ///
  explicit structured_block_2d(const abstract_poset_member& xother,
                               bool xnew_jem = false);
  ...
  ///
  /// Creates a new structured_block_2d state in host() with
  ...
  ///
  /// Creates a new structured_block_2d state in xhost with
  /// i_size() == xi_size and j_size() == xj_size and attaches
  /// this to it.
  ///
...
private:
  ...
  ///
  /// Computes an offset from i, j using the usual array index formula.
  ///
  inline pod_index_type offset(pod_index_type i, pod_index_type j) const
  {
    return (i *= j_size()) += j;
  };
...
public:
  ...
  {
    return reinterpret_cast<chart_point_2d*>(structured_block::refine_point(xpt));
  };
  ...
  {
    return reinterpret_cast<chart_point_2d*>(structured_block::unrefine_point(xpt));
  };
...
public:
  ...
  ///
  inline structured_block_2d* clone(bool xnew_state, bool xauto_access = true) const
  {
    return static_cast<structured_block_2d*>(structured_block::clone(xnew_state, xauto_access));
  };
...
public:
  ...
  ///
  inline structured_block_2d* greatest_jem() const
  {
    return static_cast<structured_block_2d*>(base_space_member::greatest_jem());
  };

  ///
  /// The smallest member which is join-equivalent to this
  ///
  inline structured_block_2d* least_jem() const
  {
    return static_cast<structured_block_2d*>(base_space_member::least_jem());
  };
...
public:
  ...
  ///
  inline structured_block_2d* p_join(abstract_poset_member* other) const
  {
    return static_cast<structured_block_2d*>(base_space_member::p_join(other));
  };
  ...
  ///
  inline structured_block_2d* p_meet(abstract_poset_member* other)
  {
    return static_cast<structured_block_2d*>(base_space_member::p_meet(other));
  };
...
public:
  ...
  /// jims in the poset
  ///
  inline structured_block_2d* l_join(abstract_poset_member* other, bool xnew_jem = true)
  {
    return static_cast<structured_block_2d*>(base_space_member::l_join(other, xnew_jem));
  };
  ...
  ///
  inline structured_block_2d* l_meet(abstract_poset_member* other, bool xnew_jem = true)
  {
    return static_cast<structured_block_2d*>(base_space_member::l_meet(other, xnew_jem));
  };
  ...
  /// this.l_meet(m) = 0
  ///
  inline structured_block_2d* l_not(bool xnew_jem = true) const
  {
    return static_cast<structured_block_2d*>(base_space_member::l_not(xnew_jem));
  };
...
public:
  ...
  /// Assignment operator
  ///
  structured_block_2d& operator=(const structured_block_2d& xother);
...
#endif // COM_LIMITPOINT_FIBER_BUNDLE_STRUCTURED_BLOCK_2D_H
