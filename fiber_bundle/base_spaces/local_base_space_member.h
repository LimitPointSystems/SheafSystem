...
#ifndef COM_LIMITPOINT_FIBER_BUNDLE_LOCAL_BASE_SPACE_MEMBER_H
#define COM_LIMITPOINT_FIBER_BUNDLE_LOCAL_BASE_SPACE_MEMBER_H
...
#endif // COM_LIMITPOINT_FIBER_BUNDLE_LOCAL_BASE_SPACE_MEMBER_H
