...
/// @file
/// Interface for class structured_block_2d_crg_interval

#ifndef COM_LIMITPOINT_FIBER_BUNDLE_STRUCTURED_BLOCK_2D_CRG_INTERVAL_H
#define COM_LIMITPOINT_FIBER_BUNDLE_STRUCTURED_BLOCK_2D_CRG_INTERVAL_H
...
///
class SHEAF_DLL_SPEC structured_block_2d_crg_interval : public homogeneous_block_crg_interval
{

  friend class fiber_bundles_namespace;

  // ===========================================================
  /// @name STRUCTURED_BLOCK_2D_CRG_INTERVAL FACET
  // ===========================================================
  //@{
...
#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_STRUCTURED_BLOCK_2D_CRG_INTERVAL_H
