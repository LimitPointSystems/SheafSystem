...
// Interface for class uniform_2d

#ifndef COM_LIMITPOINT_FIBER_BUNDLE_UNIFORM_2D_H
#define COM_LIMITPOINT_FIBER_BUNDLE_UNIFORM_2D_H
...
/// over a square 2D domain. Intended for use with uniform meshes.
///
///
class SHEAF_DLL_SPEC uniform_2d : public linear_fcn_space
{

  // ===========================================================
  /// @name UNIFORM_2D FACET
  // ===========================================================
  //@{
...
public:
  ...
  /// Assignment operator
  ///
  uniform_2d& operator=(const uniform_2d& xother);
...
#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_UNIFORM_2D_H
