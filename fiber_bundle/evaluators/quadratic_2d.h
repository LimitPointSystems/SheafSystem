...
// Interface for class quadratic_2d

#ifndef COM_LIMITPOINT_FIBER_BUNDLE_QUADRATIC_2D_H
#define COM_LIMITPOINT_FIBER_BUNDLE_QUADRATIC_2D_H
...
///
class SHEAF_DLL_SPEC quadratic_2d : public linear_fcn_space
{

  // ===========================================================
  /// @name QUADRATIC_2D FACET
  // ===========================================================
  //@{
...
public:
  ...
  /// Assignment operator
  ///
  quadratic_2d& operator=(const quadratic_2d& xother);
