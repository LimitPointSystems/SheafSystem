...
#ifndef COM_LIMITPOINT_FIBER_BUNDLE_CONSTANT_QUAD_H
#define COM_LIMITPOINT_FIBER_BUNDLE_CONSTANT_QUAD_H
...
#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_CONSTANT_QUAD_H
