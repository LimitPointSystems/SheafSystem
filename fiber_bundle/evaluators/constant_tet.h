...
#ifndef COM_LIMITPOINT_FIBER_BUNDLE_CONSTANT_TET_H
#define COM_LIMITPOINT_FIBER_BUNDLE_CONSTANT_TET_H
...
#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_CONSTANT_TET_H
