...
// Interface for class linear_1d

#ifndef COM_LIMITPOINT_FIBER_BUNDLE_LINEAR_1D_H
#define COM_LIMITPOINT_FIBER_BUNDLE_LINEAR_1D_H
...
///
class SHEAF_DLL_SPEC linear_1d : public linear_fcn_space
{

  // ===========================================================
  /// @name LINEAR_1D FACET
  // ===========================================================
  //@{
...
public:
  ...
  ///
  double inverse_jacobian(const double xjacobian[],
                          double xinverse_jacobian[]);
...
public:
  ...
  //   virtual dof_type min(const dof_type xdofs[], size_type xdofs_ub);

  //   virtual dof_type max(const dof_type xdofs[], size_type xdofs_ub);
...
public:
  ...
  /// Assignment operator
  ///
  linear_1d& operator=(const linear_1d& xother);
...
#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_LINEAR_1D_H
