...
// Interface for class quadratic_1d

#ifndef COM_LIMITPOINT_FIBER_BUNDLE_QUADRATIC_1D_H
#define COM_LIMITPOINT_FIBER_BUNDLE_QUADRATIC_1D_H
...
///
///
class SHEAF_DLL_SPEC quadratic_1d : public linear_fcn_space
{

  // ===========================================================
  /// @name QUADRATIC_1D FACET
  // ===========================================================
  //@{
...
public:
  ...
  /// Assignment operator
  ///
  quadratic_1d& operator=(const quadratic_1d& xother);
...
#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_QUADRATIC_1D_H
