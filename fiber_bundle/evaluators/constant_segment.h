...
#ifndef COM_LIMITPOINT_FIBER_BUNDLE_CONSTANT_SEGMENT_H
#define COM_LIMITPOINT_FIBER_BUNDLE_CONSTANT_SEGMENT_H
...
#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_CONSTANT_SEGMENT_H
