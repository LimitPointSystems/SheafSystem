...
#define COM_LIMITPOINT_FIBER_BUNDLE_LINEAR_FCN_SPACE_H

#ifndef COM_LIMITPOINT_FIBER_BUNDLE_INTEGRABLE_SECTION_EVALUATOR_H
...
#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_LINEAR_FCN_SPACE_H
