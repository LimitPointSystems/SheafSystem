...
// Interface for class quadratic_3d

#ifndef COM_LIMITPOINT_FIBER_BUNDLE_QUADRATIC_3D_H
#define COM_LIMITPOINT_FIBER_BUNDLE_QUADRATIC_3D_H
...
///
class SHEAF_DLL_SPEC quadratic_3d : public linear_fcn_space
{

  // ===========================================================
  /// @name QUADRATIC_3D FACET
  // ===========================================================
  //@{
...
public:
  ...
  /// Assignment operator
  ///
  quadratic_3d& operator=(const quadratic_3d& xother);
