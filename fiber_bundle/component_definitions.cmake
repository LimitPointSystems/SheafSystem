...
if(WIN64INTEL OR WIN64MSVC)
    ...
    #
    set(${COMPONENT}_IMPORT_LIBS ${SHEAF_IMPORT_LIBS} 
    ...
    #
    set(${COMPONENT}_STATIC_LIBS ${SHEAF_STATIC_LIBS} 
    ...
    # Set the cumulative shared library var for this component.
    #
    set(${COMPONENT}_SHARED_LIBS ${SHEAF_SHARED_LIBS} 
...
#
set(${COMPONENT}_JAVA_BINDING_LIBS ${SHEAF_JAVA_BINDING_LIBS} 
...
#
set(${COMPONENT}_PYTHON_BINDING_LIBS ${SHEAF_PYTHON_BINDING_LIBS} 
