...
#ifndef COM_LIMITPOINT_FIBER_BUNDLE_SPARSE_SECTION_DOF_MAP_H
#define COM_LIMITPOINT_FIBER_BUNDLE_SPARSE_SECTION_DOF_MAP_H
...
#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_SPARSE_SECTION_DOF_MAP_H
