...
/// @file
/// Interface for class i_connectivity_implicit_index_space_iterator

#ifndef COM_LIMITPOINT_FIBER_BUNDLE_I_CONNECTIVITY_IMPLICIT_INDEX_SPACE_ITERATOR_H
#define COM_LIMITPOINT_FIBER_BUNDLE_I_CONNECTIVITY_IMPLICIT_INDEX_SPACE_ITERATOR_H
...
/// space in an i_connectivity_index_space_interval.
///
class SHEAF_DLL_SPEC i_connectivity_implicit_index_space_iterator : public implicit_index_space_iterator
{

  friend class i_connectivity_implicit_index_space_interval;

  // ===========================================================
  /// @name I_CONNECTIVITY_IMPLICIT_INDEX_SPACE_ITERATOR FACET
  // ===========================================================
  //@{
...
public:
  ...
  /// Destructor
  ///
  virtual ~i_connectivity_implicit_index_space_iterator();
...
public:
  ...
  /// Assignment operator.
  ///
  virtual i_connectivity_implicit_index_space_iterator& operator=(const index_space_iterator& xother);
...
#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_I_CONNECTIVITY_IMPLICIT_INDEX_SPACE_ITERATOR_H
