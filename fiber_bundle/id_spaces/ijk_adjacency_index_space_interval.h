...
/// @file
/// Interface for class ijk_adjacency_index_space_interval

#ifndef COM_LIMITPOINT_FIBER_BUNDLE_IJK_ADJACENCY_INDEX_SPACE_INTERVAL_H
#define COM_LIMITPOINT_FIBER_BUNDLE_IJK_ADJACENCY_INDEX_SPACE_INTERVAL_H
...
/// id spaces for the adjacency of a 3-dimensional structured block.
///
...
protected:
  ...
  /// The iterator pool.
  ///
  mutable list_pool<ijk_adjacency_implicit_index_space_iterator> _iterators;
...
///
SHEAF_DLL_SPEC 
size_t deep_size(const ijk_adjacency_index_space_interval& xn, bool xinclude_shallow = true);
  
} // end namespace fiber_bundle

#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_IJK_ADJACENCY_INDEX_SPACE_INTERVAL_H
