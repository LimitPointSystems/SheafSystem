...
/// @file
/// Interface for class i_connectivity_index_space_interval

#ifndef COM_LIMITPOINT_FIBER_BUNDLE_I_CONNECTIVITY_INDEX_SPACE_INTERVAL_H
#define COM_LIMITPOINT_FIBER_BUNDLE_I_CONNECTIVITY_INDEX_SPACE_INTERVAL_H
...
public:
  ...
  ///
  /// Create a new interval of id spaces for 1D structured block connectivity
  /// in the id space family xid_spaces with upper bound xub,
  /// and vertex hub begin xvertex_hub_begin.
  /// Return a reference to the id space interval.
  ///
  static const i_connectivity_index_space_interval& new_space(index_space_family& xid_spaces,
							      size_type xub,
...
private:
  ...
  // ===========================================================
  /// @name I_CONNECTIVITY_INDEX_SPACE_INTERVAL FACET
  // ===========================================================
  //@{
...
public:
  ...
  ///
  /// The hub id of the vertex (0) for id space with id xlocal_id.
  ///
...
protected:
  ...
  /// The iterator pool.
  ///
  mutable list_pool<i_connectivity_implicit_index_space_iterator> _iterators;
...
///
SHEAF_DLL_SPEC 
size_t deep_size(const i_connectivity_index_space_interval& xn, bool xinclude_shallow = true);
  
} // end namespace fiber_bundle

#endif // ifndefCOM_LIMITPOINT_FIBER_BUNDLE_I_CONNECTIVITY_INDEX_SPACE_INTERVAL_H
