...
/// @file
/// Interface for class ijk_connectivity_index_space_interval

#ifndef COM_LIMITPOINT_FIBER_BUNDLE_IJK_CONNECTIVITY_INDEX_SPACE_INTERVAL_H
#define COM_LIMITPOINT_FIBER_BUNDLE_IJK_CONNECTIVITY_INDEX_SPACE_INTERVAL_H
...
/// id spaces for the connectivity of an 3-dimensional structured block.
///
class SHEAF_DLL_SPEC ijk_connectivity_index_space_interval : public index_space_interval
{
...
public:
  ...
  /// vertex hub begin xvertex_hub_begin, the number of zones in the
  /// j-direction xj_size, and the number of zones in the k-direction xk_size.
  /// Return a reference to the id space interval.
  ///
  static const ijk_connectivity_index_space_interval& new_space(index_space_family& xid_spaces,
								size_type xub,
...
private:
  ...
  // ===========================================================
  /// @name IJK_CONNECTIVITY_INDEX_SPACE_INTERVAL FACET
  // ===========================================================
  //@{
...
public:
  ...
  ///
  /// The hub id of the vertex (0, 0, 0) for id space with id xlocal_id.
  ///
...
protected:
  ...
  /// The iterator pool.
  ///
  mutable list_pool<ijk_connectivity_implicit_index_space_iterator> _iterators;
...
///
SHEAF_DLL_SPEC 
size_t deep_size(const ijk_connectivity_index_space_interval& xn, bool xinclude_shallow = true);
  
} // end namespace fiber_bundle

#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_IJK_CONNECTIVITY_INDEX_SPACE_INTERVAL_H
