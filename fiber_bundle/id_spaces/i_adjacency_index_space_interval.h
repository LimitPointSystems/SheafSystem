...
/// @file
/// Interface for class i_adjacency_index_space_interval

#ifndef COM_LIMITPOINT_FIBER_BUNDLE_I_ADJACENCY_INDEX_SPACE_INTERVAL_H
#define COM_LIMITPOINT_FIBER_BUNDLE_I_ADJACENCY_INDEX_SPACE_INTERVAL_H
...
/// id spaces for the adjacency of a 1-dimensional structured block.
///
class SHEAF_DLL_SPEC i_adjacency_index_space_interval : public index_space_interval
{
...
public:
  ...
  ///
  /// Create a new interval of id spaces for 1D structured block adjacency
  /// in the id space family xid_spaces with upper bound xub,
  /// zone hub begin and the number of zones in the i-direction, xi_size.
  /// Return a reference to the id space interval.
  ///
  static const i_adjacency_index_space_interval& new_space(index_space_family& xid_spaces,
							   size_type xub,
...
private:
  ...
  // ===========================================================
  /// @name I_ADJACENCY_INDEX_SPACE_INTERVAL FACET
  // ===========================================================
  //@{
...
protected:
  ...
  /// The iterator pool.
  ///
  mutable list_pool<i_adjacency_implicit_index_space_iterator> _iterators;
...
///
SHEAF_DLL_SPEC 
size_t deep_size(const i_adjacency_index_space_interval& xn, bool xinclude_shallow = true);
  
} // end namespace fiber_bundle

#endif // ifndef COM_LIMITPOINT_FIBER_BUNDLE_I_ADJACENCY_INDEX_SPACE_INTERVAL_H
