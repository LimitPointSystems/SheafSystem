...
#ifndef COM_LIMITPOINT_FIELDS_BARYCENTRIC_QUAD_REFINER_H
#define COM_LIMITPOINT_FIELDS_BARYCENTRIC_QUAD_REFINER_H
...
#endif // ifndef COM_LIMITPOINT_FIELDS_BARYCENTRIC_QUAD_REFINER_H
