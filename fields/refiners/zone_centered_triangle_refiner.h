...
#ifndef COM_LIMITPOINT_FIELDS_ZONE_CENTERED_TRIANGLE_REFINER_H
#define COM_LIMITPOINT_FIELDS_ZONE_CENTERED_TRIANGLE_REFINER_H
...
///
/// A field refiner that introduces a new vertex in the center
/// of a triangle, but not in the edges.
///
class SHEAF_DLL_SPEC zone_centered_triangle_refiner : public local_field_refiner
{

  // ===========================================================
  /// @name ZONE_CENTERED_TRIANGLE_REFINER FACET
  // ===========================================================
  //@{
...
private:
  ...
  ///
  enum static_const_int {REFINED_ZONE_CT = 3};
  //  static const size_type REFINED_ZONE_CT = 3;
...
public:
  ...
  /// Assignment operator
  ///
  zone_centered_triangle_refiner& operator=(const zone_centered_triangle_refiner& xother);

  ///
  /// Destructor.
  ///
  virtual ~zone_centered_triangle_refiner();
...
#endif // ifndef COM_LIMITPOINT_FIELDS_ZONE_CENTERED_TRIANGLE_REFINER_H
