...
#ifndef COM_LIMITPOINT_FIELDS_EDGE_CENTERED_REFINER_FAMILY_H
#define COM_LIMITPOINT_FIELDS_EDGE_CENTERED_REFINER_FAMILY_H
...
#endif // ifndef COM_LIMITPOINT_FIELDS_EDGE_CENTERED_REFINER_FAMILY_H
