...
#ifndef COM_LIMITPOINT_FIELDS_VARIANCE_BOUND_REFINEMENT_POLICY_H
#define COM_LIMITPOINT_FIELDS_VARIANCE_BOUND_REFINEMENT_POLICY_H
...
#endif // ifndef COM_LIMITPOINT_FIELDS_VARIANCE_BOUND_REFINEMENT_POLICY_H
