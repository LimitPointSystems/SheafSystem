...
#ifndef COM_LIMITPOINT_FIELDS_ZONE_CENTERED_SEGMENT_REFINER_H
#define COM_LIMITPOINT_FIELDS_ZONE_CENTERED_SEGMENT_REFINER_H
...
#endif // ifndef COM_LIMITPOINT_FIELDS_ZONE_CENTERED_SEGMENT_REFINER_H
