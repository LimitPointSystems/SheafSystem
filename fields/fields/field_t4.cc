...
// $RCSfile: field_t4.cc,v $ $Revision: 1.12 $ $Date: 2013/03/13 00:58:56 $
...
fields::field_t4::
field_t4()
  : field_tp(new sec_t4, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
fields::field_t4&
fields::field_t4::
operator=(const field_t4& xother)
{
  // Preconditions:
...
fields::field_t4&
fields::field_t4::
operator=(const sec_t4& xsection)
{
  // Preconditions:
...
property() const
{
  ...
  sec_t4& result = dynamic_cast<sec_t4&>(*_property);
...
bool
fields::field_t4::
same_property_fiber_schema(const field_t4& xother, bool xauto_access) const
{
  bool result;
...
static_class_name()
{
  ...
  static const string result("field_t4");
...
is_ancestor_of(const any* xother) const
{
  ...
  bool result = dynamic_cast<const field_t4*>(xother) != 0;
...
fields::field_t4&
fields::
operator>>(const field_t4& xsrc, field_t4& xdst)
{
  // Preconditions:
...
ostream&
fields::
operator<<(ostream& xos, const field_t4& xfield)
{
  // Preconditions:
