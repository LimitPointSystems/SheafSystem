...
// $RCSfile: field_st3_e3.h,v $ $Revision: 1.15 $ $Date: 2013/03/21 17:40:19 $
...
///
SHEAF_DLL_SPEC
field_st3_e3& operator>>(const field_st3_e3& xsrc, field_st3_e3& xdst);

///
/// Inserts field_st3_e3 xfield into ostream xos.
///
SHEAF_DLL_SPEC
ostream& operator<<(ostream& xos, const field_st3_e3& xfield);
