...
// $RCSfile: field_e1_uniform.cc,v $ $Revision: 1.12 $ $Date: 2013/03/13 00:58:55 $
...
//=============================================================================
// FIELD_VD FACET OF CLASS FIELD_E1_UNIFORM
//=============================================================================

///
fields::field_e1_uniform::
field_e1_uniform()
  : field_e1(new sec_e1_uniform, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
///
fields::field_e1_uniform::
field_e1_uniform(const sec_ed& xcoordinates, const sec_e1_uniform& xproperty, bool xauto_access)
  : field_e1(new sec_e1_uniform, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
field_e1_uniform(sec_e1_uniform* xproperty,
  ...
  : field_e1(xproperty, xcoordinates, xbase_space)
{
  // Preconditions:
...
fields::field_e1_uniform&
fields::field_e1_uniform::
operator=(const field_e1_uniform& xother)
{
  // Preconditions:
...
fields::field_e1_uniform&
fields::field_e1_uniform::
operator=(const sec_e1_uniform& xsection)
{
  // Preconditions:
...
property() const
{
  ...
  sec_e1_uniform& result = dynamic_cast<sec_e1_uniform&>(*_property);
...
bool
fields::field_e1_uniform::
same_property_fiber_schema(const field_e1_uniform& xother, bool xauto_access) const
{
  bool result;
...
//=============================================================================
// ANY FACET OF CLASS FIELD_E1_UNIFORM
//=============================================================================
...
static_class_name()
{
  ...
  static const string result("field_e1_uniform");
...
is_ancestor_of(const any* xother) const
{
  ...
  bool result = dynamic_cast<const field_e1_uniform*>(xother) != 0;
...
clone() const
{
  field_e1_uniform* result;

  // Preconditions:

  // Body:

  result = new field_e1_uniform();
...
fields::field_e1_uniform&
fields::
operator>>(const field_e1_uniform& xsrc, field_e1_uniform& xdst)
{
  // Preconditions:
...
ostream&
fields::
operator<<(ostream& xos, const field_e1_uniform& xfield)
{
  // Preconditions:
