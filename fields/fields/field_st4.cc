...
// $RCSfile: field_st4.cc,v $ $Revision: 1.12 $ $Date: 2013/03/13 00:58:56 $
...
//=============================================================================
// FIELD_VD FACET OF CLASS FIELD_ST4
//=============================================================================

///
fields::field_st4::
field_st4()
  : field_stp(new sec_st4, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
///
fields::field_st4::
field_st4(const sec_ed& xcoordinates, const sec_st4& xproperty, bool xauto_access)
  : field_stp(new sec_st4, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
field_st4(sec_st4* xproperty,
  ...
  : field_stp(xproperty, xcoordinates, xbase_space)
{
  // Preconditions:
...
fields::field_st4&
fields::field_st4::
operator=(const field_st4& xother)
{
  // Preconditions:
...
fields::field_st4&
fields::field_st4::
operator=(const sec_st4& xsection)
{
  // Preconditions:
...
property() const
{
  ...
  sec_st4& result = dynamic_cast<sec_st4&>(*_property);
...
bool
fields::field_st4::
same_property_fiber_schema(const field_st4& xother, bool xauto_access) const
{
  bool result;
...
static_class_name()
{
  ...
  static const string result("field_st4");
...
is_ancestor_of(const any* xother) const
{
  ...
  bool result = dynamic_cast<const field_st4*>(xother) != 0;
...
invariant() const
{
  ...
  if(invariant_check())
  {
    ...
    invariance(field_stp::invariant());
...
fields::field_st4&
fields::
operator>>(const field_st4& xsrc, field_st4& xdst)
{
  // Preconditions:
...
ostream&
fields::
operator<<(ostream& xos, const field_st4& xfield)
{
  // Preconditions:
