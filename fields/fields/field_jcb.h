...
// $RCSfile: field_jcb.h,v $ $Revision: 1.15 $ $Date: 2013/03/21 17:40:19 $
...
///
SHEAF_DLL_SPEC
field_jcb& operator>>(const field_jcb& xsrc, field_jcb& xdst);

///
/// Inserts field_jcb xfield into ostream xos.
///
SHEAF_DLL_SPEC
ostream& operator<<(ostream& xos, const field_jcb& xfield);
