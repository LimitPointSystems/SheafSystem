...
// $RCSfile: field_at2.h,v $ $Revision: 1.15 $ $Date: 2013/03/21 17:40:18 $
...
///
SHEAF_DLL_SPEC
field_at2& operator>>(const field_at2& xsrc, field_at2& xdst);

///
/// Inserts field_at2 xfield into ostream xos.
///
SHEAF_DLL_SPEC
ostream& operator<<(ostream& xos, const field_at2& xfield);
