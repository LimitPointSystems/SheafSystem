...
// $RCSfile: field_jcb_e23.h,v $ $Revision: 1.15 $ $Date: 2013/03/21 17:40:19 $
...
///
SHEAF_DLL_SPEC
field_jcb_e23& operator>>(const field_jcb_e23& xsrc, field_jcb_e23& xdst);

///
/// Inserts field_jcb_e23 xfield into ostream xos.
///
SHEAF_DLL_SPEC
ostream& operator<<(ostream& xos, const field_jcb_e23& xfield);
