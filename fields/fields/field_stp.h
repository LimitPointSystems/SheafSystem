...
// $RCSfile: field_stp.h,v $ $Revision: 1.15 $ $Date: 2013/03/21 17:40:19 $
...
///
SHEAF_DLL_SPEC
field_stp& operator>>(const field_stp& xsrc, field_stp& xdst);

///
/// Inserts field_stp xfield into ostream xos.
///
SHEAF_DLL_SPEC
ostream& operator<<(ostream& xos, const field_stp& xfield);
