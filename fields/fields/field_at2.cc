...
// $RCSfile: field_at2.cc,v $ $Revision: 1.12 $ $Date: 2013/03/13 00:58:54 $
...
//=============================================================================
// FIELD_VD FACET OF CLASS FIELD_AT2
//=============================================================================

///
fields::field_at2::
field_at2()
  : field_atp(new sec_at2, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
///
fields::field_at2::
field_at2(const sec_ed& xcoordinates, const sec_at2& xproperty, bool xauto_access)
  : field_atp(new sec_at2, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
fields::field_at2&
fields::field_at2::
operator=(const field_at2& xother)
{
  // Preconditions:
...
fields::field_at2&
fields::field_at2::
operator=(const sec_at2& xsection)
{
  // Preconditions:
...
property() const
{
  ...
  sec_at2& result = dynamic_cast<sec_at2&>(*_property);
...
bool
fields::field_at2::
same_property_fiber_schema(const field_at2& xother, bool xauto_access) const
{
  bool result;
...
static_class_name()
{
  ...
  static const string result("field_at2");
...
is_ancestor_of(const any* xother) const
{
  ...
  bool result = dynamic_cast<const field_at2*>(xother) != 0;
...
fields::field_at2&
fields::
operator>>(const field_at2& xsrc, field_at2& xdst)
{
  // Preconditions:
...
ostream&
fields::
operator<<(ostream& xos, const field_at2& xfield)
{
  // Preconditions:
