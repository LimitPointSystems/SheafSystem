...
// $RCSfile: field_st3.cc,v $ $Revision: 1.12 $ $Date: 2013/03/13 00:58:56 $
...
//=============================================================================
// FIELD_VD FACET OF CLASS FIELD_ST3
//=============================================================================

///
fields::field_st3::
field_st3()
  : field_stp(new sec_st3, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
///
fields::field_st3::
field_st3(const sec_ed& xcoordinates, const sec_st3& xproperty, bool xauto_access)
  : field_stp(new sec_st3, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
fields::field_st3&
fields::field_st3::
operator=(const field_st3& xother)
{
  // Preconditions:
...
fields::field_st3&
fields::field_st3::
operator=(const sec_st3& xsection)
{
  // Preconditions:
...
fields::field_st3&
fields::field_st3::
operator=(const st3_lite& xfiber)
{
  // Preconditions:
...
property() const
{
  ...
  sec_st3& result = dynamic_cast<sec_st3&>(*_property);
...
bool
fields::field_st3::
same_property_fiber_schema(const field_st3& xother, bool xauto_access) const
{
  bool result;
...
static_class_name()
{
  ...
  static const string result("field_st3");
...
is_ancestor_of(const any* xother) const
{
  ...
  bool result = dynamic_cast<const field_st3*>(xother) != 0;
...
fields::field_st3&
fields::
operator>>(const field_st3& xsrc, field_st3& xdst)
{
  // Preconditions:
...
ostream&
fields::
operator<<(ostream& xos, const field_st3& xfield)
{
  // Preconditions:
