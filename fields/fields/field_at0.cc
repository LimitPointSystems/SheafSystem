...
// $RCSfile: field_at0.cc,v $ $Revision: 1.13 $ $Date: 2013/03/13 00:58:54 $
...
//=============================================================================
// FIELD_VD FACET OF CLASS FIELD_AT0
//=============================================================================

///
fields::field_at0::
field_at0()
  : field_atp(new sec_at0, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
fields::field_at0&
fields::field_at0::
operator=(const field_at0& xother)
{
  // Preconditions:
...
fields::field_at0&
fields::field_at0::
operator=(const sec_at0& xsection)
{
  // Preconditions:
...
property() const
{
  ...
  sec_at0& result = dynamic_cast<sec_at0&>(*_property);
...
bool
fields::field_at0::
same_property_fiber_schema(const field_at0& xother, bool xauto_access) const
{
  bool result;
...
static_class_name()
{
  ...
  static const string result("field_at0");
...
is_ancestor_of(const any* xother) const
{
  ...
  bool result = dynamic_cast<const field_at0*>(xother) != 0;
...
fields::field_at0&
fields::
operator>>(const field_at0& xsrc, field_at0& xdst)
{
  // Preconditions:
...
ostream&
fields::
operator<<(ostream& xos, const field_at0& xfield)
{
  // Preconditions:
...
#include "field_at0_funcs.impl.h"
