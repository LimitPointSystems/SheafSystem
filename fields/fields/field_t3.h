...
// $RCSfile: field_t3.h,v $ $Revision: 1.15 $ $Date: 2013/03/21 17:40:19 $
...
///
SHEAF_DLL_SPEC
field_t3& operator>>(const field_t3& xsrc, field_t3& xdst);

///
/// Inserts field_t3 xfield into ostream xos.
///
SHEAF_DLL_SPEC
ostream& operator<<(ostream& xos, const field_t3& xfield);
