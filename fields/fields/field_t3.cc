...
// $RCSfile: field_t3.cc,v $ $Revision: 1.12 $ $Date: 2013/03/13 00:58:56 $
...
//=============================================================================
// FIELD_VD FACET OF CLASS FIELD_T3
//=============================================================================

///
fields::field_t3::
field_t3()
  : field_tp(new sec_t3, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
///
fields::field_t3::
field_t3(const sec_ed& xcoordinates, const sec_t3& xproperty, bool xauto_access)
  : field_tp(new sec_t3, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
fields::field_t3&
fields::field_t3::
operator=(const field_t3& xother)
{
  // Preconditions:
...
fields::field_t3&
fields::field_t3::
operator=(const sec_t3& xsection)
{
  // Preconditions:
...
property() const
{
  ...
  sec_t3& result = dynamic_cast<sec_t3&>(*_property);
...
bool
fields::field_t3::
same_property_fiber_schema(const field_t3& xother, bool xauto_access) const
{
  bool result;
...
static_class_name()
{
  ...
  static const string result("field_t3");
...
is_ancestor_of(const any* xother) const
{
  ...
  bool result = dynamic_cast<const field_t3*>(xother) != 0;
...
fields::field_t3&
fields::
operator>>(const field_t3& xsrc, field_t3& xdst)
{
  // Preconditions:
