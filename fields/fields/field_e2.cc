...
// $RCSfile: field_e2.cc,v $ $Revision: 1.12 $ $Date: 2013/03/13 00:58:55 $
...
//=============================================================================
// FIELD_VD FACET OF CLASS FIELD_E2
//=============================================================================

///
fields::field_e2::
field_e2()
  : field_ed(new sec_e2, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
///
fields::field_e2::
field_e2(const sec_ed& xcoordinates, const sec_e2& xproperty, bool xauto_access)
  : field_ed(new sec_e2, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
fields::field_e2&
fields::field_e2::
operator=(const field_e2& xother)
{
  // Preconditions:
...
fields::field_e2&
fields::field_e2::
operator=(const sec_e2& xsection)
{
  // Preconditions:
...
property() const
{
  ...
  sec_e2& result = dynamic_cast<sec_e2&>(*_property);
...
bool
fields::field_e2::
same_property_fiber_schema(const field_e2& xother, bool xauto_access) const
{
  bool result;
...
static_class_name()
{
  ...
  static const string result("field_e2");
...
is_ancestor_of(const any* xother) const
{
  ...
  bool result = dynamic_cast<const field_e2*>(xother) != 0;
...
fields::field_e2&
fields::
operator>>(const field_e2& xsrc, field_e2& xdst)
{
  // Preconditions:
...
ostream&
fields::
operator<<(ostream& xos, const field_e2& xfield)
{
  // Preconditions:
