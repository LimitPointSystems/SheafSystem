...
// $RCSfile: field_jcb_e13.cc,v $ $Revision: 1.12 $ $Date: 2013/03/13 00:58:55 $
...
//=============================================================================
// FIELD_VD FACET OF CLASS FIELD_JCB_E13
//=============================================================================

///
fields::field_jcb_e13::
field_jcb_e13()
  : field_jcb_ed(new sec_jcb_e13, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
///
fields::field_jcb_e13::
field_jcb_e13(const sec_ed& xcoordinates, const sec_jcb_e13& xproperty, bool xauto_access)
  : field_jcb_ed(new sec_jcb_e13, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
fields::field_jcb_e13&
fields::field_jcb_e13::
operator=(const field_jcb_e13& xother)
{
  // Preconditions:
...
fields::field_jcb_e13&
fields::field_jcb_e13::
operator=(const sec_jcb_e13& xsection)
{
  // Preconditions:
...
property() const
{
  ...
  sec_jcb_e13& result = dynamic_cast<sec_jcb_e13&>(*_property);
...
bool
fields::field_jcb_e13::
same_property_fiber_schema(const field_jcb_e13& xother, bool xauto_access) const
{
  bool result;
...
//=============================================================================
// ANY FACET OF CLASS FIELD_JCB_E13
//=============================================================================
...
static_class_name()
{
  ...
  static const string result("field_jcb_e13");
...
is_ancestor_of(const any* xother) const
{
  ...
  bool result = dynamic_cast<const field_jcb_e13*>(xother) != 0;
...
clone() const
{
  field_jcb_e13* result;

  // Preconditions:

  // Body:

  result = new field_jcb_e13();
...
fields::field_jcb_e13&
fields::
operator>>(const field_jcb_e13& xsrc, field_jcb_e13& xdst)
{
  // Preconditions:
...
ostream&
fields::
operator<<(ostream& xos, const field_jcb_e13& xfield)
{
  // Preconditions:
