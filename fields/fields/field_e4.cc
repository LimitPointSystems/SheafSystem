...
// $RCSfile: field_e4.cc,v $ $Revision: 1.12 $ $Date: 2013/03/13 00:58:55 $
...
//=============================================================================
// FIELD_VD FACET OF CLASS FIELD_E4
//=============================================================================

///
fields::field_e4::
field_e4()
  : field_ed(new sec_e4, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
///
fields::field_e4::
field_e4(const sec_ed& xcoordinates, const sec_e4& xproperty, bool xauto_access)
  : field_ed(new sec_e4, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
fields::field_e4&
fields::field_e4::
operator=(const field_e4& xother)
{
  // Preconditions:
...
fields::field_e4&
fields::field_e4::
operator=(const sec_e4& xsection)
{
  // Preconditions:
...
property() const
{
  ...
  sec_e4& result = dynamic_cast<sec_e4&>(*_property);
...
bool
fields::field_e4::
same_property_fiber_schema(const field_e4& xother, bool xauto_access) const
{
  bool result;
...
static_class_name()
{
  ...
  static const string result("field_e4");
...
is_ancestor_of(const any* xother) const
{
  ...
  bool result = dynamic_cast<const field_e4*>(xother) != 0;
...
fields::field_e4&
fields::
operator>>(const field_e4& xsrc, field_e4& xdst)
{
  // Preconditions:
...
ostream&
fields::
operator<<(ostream& xos, const field_e4& xfield)
{
  // Preconditions:
