...
// $RCSfile: field_t2.cc,v $ $Revision: 1.12 $ $Date: 2013/03/13 00:58:56 $
...
//=============================================================================
// FIELD_VD FACET OF CLASS FIELD_T2
//=============================================================================

///
fields::field_t2::
field_t2()
  : field_tp(new sec_t2, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
///
fields::field_t2::
field_t2(const sec_ed& xcoordinates, const sec_t2& xproperty, bool xauto_access)
  : field_tp(new sec_t2, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
fields::field_t2&
fields::field_t2::
operator=(const field_t2& xother)
{
  // Preconditions:
...
fields::field_t2&
fields::field_t2::
operator=(const sec_t2& xsection)
{
  // Preconditions:
...
property() const
{
  ...
  sec_t2& result = dynamic_cast<sec_t2&>(*_property);
...
bool
fields::field_t2::
same_property_fiber_schema(const field_t2& xother, bool xauto_access) const
{
  bool result;
...
static_class_name()
{
  ...
  static const string result("field_t2");
...
is_ancestor_of(const any* xother) const
{
  ...
  bool result = dynamic_cast<const field_t2*>(xother) != 0;
...
fields::field_t2&
fields::
operator>>(const field_t2& xsrc, field_t2& xdst)
{
  // Preconditions:
...
ostream&
fields::
operator<<(ostream& xos, const field_t2& xfield)
{
  // Preconditions:
