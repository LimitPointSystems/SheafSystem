...
// $RCSfile: field_t2.h,v $ $Revision: 1.15 $ $Date: 2013/03/21 17:40:19 $
...
///
SHEAF_DLL_SPEC
field_t2& operator>>(const field_t2& xsrc, field_t2& xdst);

///
/// Inserts field_t2 xfield into ostream xos.
///
SHEAF_DLL_SPEC
ostream& operator<<(ostream& xos, const field_t2& xfield);
