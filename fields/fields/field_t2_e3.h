...
// $RCSfile: field_t2_e3.h,v $ $Revision: 1.15 $ $Date: 2013/03/21 17:40:19 $
...
///
class SHEAF_DLL_SPEC field_t2_e3 : public field_t2
{
  //===========================================================================
  /// @name FIELD_VD FACET OF CLASS FIELD_T2_E3
  //===========================================================================
  //@{
public:
  ...
  ///
  typedef sec_t2_e3 property_section_type;
  ...
  ///
  field_t2_e3(const sec_ed& xcoordinates, const sec_t2_e3& xproperty,
           bool xauto_access);
  ...
  /// Assignment operator.
  ///
  virtual field_t2_e3& operator=(const field_vd& xother);

  ///
  /// Assignment operator.
  ///
  field_t2_e3& operator=(const field_t2_e3& xother);

  ///
  /// Assignment operator.
  ///
  field_t2_e3& operator=(const sec_t2_e3& xsection);

  ///
  /// Assignment operator.
  ///
  field_t2_e3& operator=(const t2_e3& xfiber);

  ///
  /// Assignment operator.
  ///
  field_t2_e3& operator=(const t2_e3_lite& xfiber);
  ...
  ///
  sec_t2_e3& property() const;

  ///
  /// True if this has the same property fiber as xother.
  ///
  bool same_property_fiber_schema(const field_t2_e3& xother,
...
private:
  ...
  //===========================================================================
  /// @name ANY FACET OF CLASS FIELD_T2_E3
  //===========================================================================
  //@{
...
public:
  ...
  ///
  virtual field_t2_e3* clone() const;
...
///
SHEAF_DLL_SPEC
field_t2_e3& operator>>(const field_t2_e3& xsrc, field_t2_e3& xdst);

///
/// Inserts field_t2_e3 xfield into ostream xos.
///
SHEAF_DLL_SPEC
ostream& operator<<(ostream& xos, const field_t2_e3& xfield);
