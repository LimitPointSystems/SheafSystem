...
// $RCSfile: field_jcb_ed.cc,v $ $Revision: 1.12 $ $Date: 2013/03/13 00:58:55 $
...
//=============================================================================
// FIELD_VD FACET OF CLASS FIELD_JCB_ED
//=============================================================================

///
fields::field_jcb_ed::
field_jcb_ed()
  : field_jcb(new sec_jcb_ed, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
///
fields::field_jcb_ed::
field_jcb_ed(const sec_ed& xcoordinates, const sec_jcb_ed& xproperty, bool xauto_access)
  : field_jcb(new sec_jcb_ed, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
field_jcb_ed(sec_jcb_ed* xproperty,
  ...
  : field_jcb(xproperty, xcoordinates, xbase_space)
{
  // Preconditions:
...
fields::field_jcb_ed&
fields::field_jcb_ed::
operator=(const field_jcb_ed& xother)
{
  // Preconditions:
...
fields::field_jcb_ed&
fields::field_jcb_ed::
operator=(const sec_jcb_ed& xsection)
{
  // Preconditions:
...
property() const
{
  ...
  sec_jcb_ed& result = dynamic_cast<sec_jcb_ed&>(*_property);
...
bool
fields::field_jcb_ed::
same_property_fiber_schema(const field_jcb_ed& xother, bool xauto_access) const
{
  bool result;
...
//=============================================================================
// ANY FACET OF CLASS FIELD_JCB_ED
//=============================================================================
...
static_class_name()
{
  ...
  static const string result("field_jcb_ed");
...
is_ancestor_of(const any* xother) const
{
  ...
  bool result = dynamic_cast<const field_jcb_ed*>(xother) != 0;
...
invariant() const
{
  ...
  if(invariant_check())
  {
    ...
    invariance(field_jcb::invariant());
...
fields::field_jcb_ed&
fields::
operator>>(const field_jcb_ed& xsrc, field_jcb_ed& xdst)
{
  // Preconditions:
...
ostream&
fields::
operator<<(ostream& xos, const field_jcb_ed& xfield)
{
  // Preconditions:
