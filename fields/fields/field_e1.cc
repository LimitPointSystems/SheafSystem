...
// $RCSfile: field_e1.cc,v $ $Revision: 1.12 $ $Date: 2013/03/13 00:58:55 $
...
//=============================================================================
// FIELD_VD FACET OF CLASS FIELD_E1
//=============================================================================

///
fields::field_e1::
field_e1()
  : field_ed(new sec_e1, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
///
fields::field_e1::
field_e1(const sec_ed& xcoordinates, const sec_e1& xproperty, bool xauto_access)
  : field_ed(new sec_e1, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
fields::field_e1&
fields::field_e1::
operator=(const field_e1& xother)
{
  // Preconditions:
...
fields::field_e1&
fields::field_e1::
operator=(const sec_e1& xsection)
{
  // Preconditions:
...
property() const
{
  ...
  sec_e1& result = dynamic_cast<sec_e1&>(*_property);
...
bool
fields::field_e1::
same_property_fiber_schema(const field_e1& xother, bool xauto_access) const
{
  bool result;
...
static_class_name()
{
  ...
  static const string result("field_e1");
...
is_ancestor_of(const any* xother) const
{
  ...
  bool result = dynamic_cast<const field_e1*>(xother) != 0;
...
fields::field_e1&
fields::
operator>>(const field_e1& xsrc, field_e1& xdst)
{
  // Preconditions:
...
ostream&
fields::
operator<<(ostream& xos, const field_e1& xfield)
{
  // Preconditions:
