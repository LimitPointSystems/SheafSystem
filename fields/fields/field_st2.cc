...
// $RCSfile: field_st2.cc,v $ $Revision: 1.12 $ $Date: 2013/03/13 00:58:56 $
...
//=============================================================================
// FIELD_VD FACET OF CLASS FIELD_ST2
//=============================================================================

///
fields::field_st2::
field_st2()
  : field_stp(new sec_st2, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
///
fields::field_st2::
field_st2(const sec_ed& xcoordinates, const sec_st2& xproperty, bool xauto_access)
  : field_stp(new sec_st2, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
fields::field_st2&
fields::field_st2::
operator=(const field_st2& xother)
{
  // Preconditions:
...
fields::field_st2&
fields::field_st2::
operator=(const sec_st2& xsection)
{
  // Preconditions:
...
property() const
{
  ...
  sec_st2& result = dynamic_cast<sec_st2&>(*_property);
...
bool
fields::field_st2::
same_property_fiber_schema(const field_st2& xother, bool xauto_access) const
{
  bool result;
...
static_class_name()
{
  ...
  static const string result("field_st2");
...
is_ancestor_of(const any* xother) const
{
  ...
  bool result = dynamic_cast<const field_st2*>(xother) != 0;
...
fields::field_st2&
fields::
operator>>(const field_st2& xsrc, field_st2& xdst)
{
  // Preconditions:
...
ostream&
fields::
operator<<(ostream& xos, const field_st2& xfield)
{
  // Preconditions:
...
#include "field_st2_funcs.impl.h"
