...
// $RCSfile: field_e3.h,v $ $Revision: 1.15 $ $Date: 2013/03/21 17:40:18 $
...
///
class SHEAF_DLL_SPEC field_e3 : public field_ed
{
  //===========================================================================
  /// @name FIELD_VD FACET OF CLASS FIELD_E3
  //===========================================================================
  //@{
public:
  ...
  ///
  typedef sec_e3 property_section_type;
  ...
  ///
  field_e3(const sec_ed& xcoordinates, const sec_e3& xproperty,
           bool xauto_access);
  ...
  /// Assignment operator.
  ///
  virtual field_e3& operator=(const field_vd& xother);

  ///
  /// Assignment operator.
  ///
  field_e3& operator=(const field_e3& xother);

  ///
  /// Assignment operator.
  ///
  field_e3& operator=(const sec_e3& xsection);

  ///
  /// Assignment operator.
  ///
  field_e3& operator=(const e3& xfiber);

  ///
  /// Assignment operator.
  ///
  field_e3& operator=(const e3_lite& xfiber);
  ...
  ///
  bool same_property_fiber_schema(const field_e3& xother,
...
private:
  ...
  //===========================================================================
  /// @name ANY FACET OF CLASS FIELD_E3
  //===========================================================================
  //@{
...
///
SHEAF_DLL_SPEC
field_e3& operator>>(const field_e3& xsrc, field_e3& xdst);

///
/// Inserts field_e3 xfield into ostream xos.
///
SHEAF_DLL_SPEC
ostream& operator<<(ostream& xos, const field_e3& xfield);
