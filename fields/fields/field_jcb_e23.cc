...
// $RCSfile: field_jcb_e23.cc,v $ $Revision: 1.12 $ $Date: 2013/03/13 00:58:55 $
...
//=============================================================================
// FIELD_VD FACET OF CLASS FIELD_JCB_E23
//=============================================================================

///
fields::field_jcb_e23::
field_jcb_e23()
  : field_jcb_ed(new sec_jcb_e23, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
///
fields::field_jcb_e23::
field_jcb_e23(const sec_ed& xcoordinates, const sec_jcb_e23& xproperty, bool xauto_access)
  : field_jcb_ed(new sec_jcb_e23, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
fields::field_jcb_e23&
fields::field_jcb_e23::
operator=(const field_jcb_e23& xother)
{
  // Preconditions:
...
fields::field_jcb_e23&
fields::field_jcb_e23::
operator=(const sec_jcb_e23& xsection)
{
  // Preconditions:
...
property() const
{
  ...
  sec_jcb_e23& result = dynamic_cast<sec_jcb_e23&>(*_property);
...
bool
fields::field_jcb_e23::
same_property_fiber_schema(const field_jcb_e23& xother, bool xauto_access) const
{
  bool result;
...
//=============================================================================
// ANY FACET OF CLASS FIELD_JCB_E23
//=============================================================================
...
static_class_name()
{
  ...
  static const string result("field_jcb_e23");
...
is_ancestor_of(const any* xother) const
{
  ...
  bool result = dynamic_cast<const field_jcb_e23*>(xother) != 0;
...
clone() const
{
  field_jcb_e23* result;

  // Preconditions:

  // Body:

  result = new field_jcb_e23();
...
fields::field_jcb_e23&
fields::
operator>>(const field_jcb_e23& xsrc, field_jcb_e23& xdst)
{
  // Preconditions:
...
ostream&
fields::
operator<<(ostream& xos, const field_jcb_e23& xfield)
{
  // Preconditions:
