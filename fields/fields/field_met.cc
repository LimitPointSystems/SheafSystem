...
// $RCSfile: field_met.cc,v $ $Revision: 1.12 $ $Date: 2013/03/13 00:58:55 $
...
//=============================================================================
// FIELD_VD FACET OF CLASS FIELD_MET
//=============================================================================

///
fields::field_met::
field_met()
  : field_st2(new sec_met, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
///
fields::field_met::
field_met(const sec_ed& xcoordinates, const sec_met& xproperty, bool xauto_access)
  : field_st2(new sec_met, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
fields::field_met&
fields::field_met::
operator=(const field_met& xother)
{
  // Preconditions:
...
fields::field_met&
fields::field_met::
operator=(const sec_met& xsection)
{
  // Preconditions:
...
property() const
{
  ...
  sec_met& result = dynamic_cast<sec_met&>(*_property);
...
bool
fields::field_met::
same_property_fiber_schema(const field_met& xother, bool xauto_access) const
{
  bool result;
...
static_class_name()
{
  ...
  static const string result("field_met");
...
is_ancestor_of(const any* xother) const
{
  ...
  bool result = dynamic_cast<const field_met*>(xother) != 0;
...
fields::field_met&
fields::
operator>>(const field_met& xsrc, field_met& xdst)
{
  // Preconditions:
...
ostream&
fields::
operator<<(ostream& xos, const field_met& xfield)
{
  // Preconditions:
...
#include "field_met_funcs.impl.h"
