...
// $RCSfile: field_e3_uniform.cc,v $ $Revision: 1.12 $ $Date: 2013/03/13 00:58:55 $
...
//=============================================================================
// FIELD_VD FACET OF CLASS FIELD_E3_UNIFORM
//=============================================================================

///
fields::field_e3_uniform::
field_e3_uniform()
  : field_e3(new sec_e3_uniform, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
///
fields::field_e3_uniform::
field_e3_uniform(const sec_ed& xcoordinates, const sec_e3_uniform& xproperty, bool xauto_access)
  : field_e3(new sec_e3_uniform, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
field_e3_uniform(sec_e3_uniform* xproperty,
  ...
  : field_e3(xproperty, xcoordinates, xbase_space)
{
  // Preconditions:
...
fields::field_e3_uniform&
fields::field_e3_uniform::
operator=(const field_e3_uniform& xother)
{
  // Preconditions:
...
fields::field_e3_uniform&
fields::field_e3_uniform::
operator=(const sec_e3_uniform& xsection)
{
  // Preconditions:
...
property() const
{
  ...
  sec_e3_uniform& result = dynamic_cast<sec_e3_uniform&>(*_property);
...
bool
fields::field_e3_uniform::
same_property_fiber_schema(const field_e3_uniform& xother, bool xauto_access) const
{
  bool result;
...
//=============================================================================
// ANY FACET OF CLASS FIELD_E3_UNIFORM
//=============================================================================
...
static_class_name()
{
  ...
  static const string result("field_e3_uniform");
...
is_ancestor_of(const any* xother) const
{
  ...
  bool result = dynamic_cast<const field_e3_uniform*>(xother) != 0;
...
clone() const
{
  field_e3_uniform* result;

  // Preconditions:

  // Body:

  result = new field_e3_uniform();
...
fields::field_e3_uniform&
fields::
operator>>(const field_e3_uniform& xsrc, field_e3_uniform& xdst)
{
  // Preconditions:
...
ostream&
fields::
operator<<(ostream& xos, const field_e3_uniform& xfield)
{
  // Preconditions:
