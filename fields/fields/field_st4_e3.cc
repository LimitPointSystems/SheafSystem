...
// $RCSfile: field_st4_e3.cc,v $ $Revision: 1.12 $ $Date: 2013/03/13 00:58:56 $
...
//=============================================================================
// FIELD_VD FACET OF CLASS FIELD_ST4_E3
//=============================================================================

///
fields::field_st4_e3::
field_st4_e3()
  : field_st4(new sec_st4_e3, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
///
fields::field_st4_e3::
field_st4_e3(const field_st4_e3& xother, bool xauto_access)
  : field_st4(new sec_st4_e3, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
///
fields::field_st4_e3::
field_st4_e3(const sec_ed& xcoordinates, const sec_st4_e3& xproperty, bool xauto_access)
  : field_st4(new sec_st4_e3, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
///
fields::field_st4_e3::
field_st4_e3(namespace_poset& xns,
...
///
fields::field_st4_e3::
field_st4_e3(sec_st4_e3* xproperty,
         sec_ed_invertible* xcoordinates,
         base_space_member* xbase_space)
  : field_st4(xproperty, xcoordinates, xbase_space)
{
  // Preconditions:
...
fields::field_st4_e3&
fields::field_st4_e3::
operator=(const field_st4_e3& xother)
{
  // Preconditions:
...
fields::field_st4_e3&
fields::field_st4_e3::
operator=(const sec_st4_e3& xsection)
{
  // Preconditions:
...
property() const
{
  ...
  sec_st4_e3& result = dynamic_cast<sec_st4_e3&>(*_property);
...
bool
fields::field_st4_e3::
same_property_fiber_schema(const field_st4_e3& xother, bool xauto_access) const
{
  bool result;
...
//=============================================================================
// ANY FACET OF CLASS FIELD_ST4_E3
//=============================================================================
...
static_class_name()
{
  ...
  static const string result("field_st4_e3");
...
is_ancestor_of(const any* xother) const
{
  ...
  bool result = dynamic_cast<const field_st4_e3*>(xother) != 0;
...
invariant() const
{
  ...
  if(invariant_check())
  {
    ...
    invariance(field_st4::invariant());
...
//=============================================================================
// NON-MEMBER FUNCTIONS OF CLASS FIELD_ST4_E3
//=============================================================================

///
fields::field_st4_e3&
fields::
operator>>(const field_st4_e3& xsrc, field_st4_e3& xdst)
{
  // Preconditions:
...
ostream&
fields::
operator<<(ostream& xos, const field_st4_e3& xfield)
{
  // Preconditions:
