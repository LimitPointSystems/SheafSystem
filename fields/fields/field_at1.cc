...
// $RCSfile: field_at1.cc,v $ $Revision: 1.12 $ $Date: 2013/03/13 00:58:54 $
...
//=============================================================================
// FIELD_VD FACET OF CLASS FIELD_AT1
//=============================================================================

///
fields::field_at1::
field_at1()
  : field_atp(new sec_at1, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
fields::field_at1&
fields::field_at1::
operator=(const field_at1& xother)
{
  // Preconditions:
...
fields::field_at1&
fields::field_at1::
operator=(const sec_at1& xsection)
{
  // Preconditions:
...
property() const
{
  ...
  sec_at1& result = dynamic_cast<sec_at1&>(*_property);
...
bool
fields::field_at1::
same_property_fiber_schema(const field_at1& xother, bool xauto_access) const
{
  bool result;
...
static_class_name()
{
  ...
  static const string result("field_at1");
...
is_ancestor_of(const any* xother) const
{
  ...
  bool result = dynamic_cast<const field_at1*>(xother) != 0;
...
fields::field_at1&
fields::
operator>>(const field_at1& xsrc, field_at1& xdst)
{
  // Preconditions:
...
ostream&
fields::
operator<<(ostream& xos, const field_at1& xfield)
{
  // Preconditions:
