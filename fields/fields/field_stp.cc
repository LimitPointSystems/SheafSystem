...
// $RCSfile: field_stp.cc,v $ $Revision: 1.12 $ $Date: 2013/03/13 00:58:56 $
...
//=============================================================================
// FIELD_VD FACET OF CLASS FIELD_STP
//=============================================================================

///
fields::field_stp::
field_stp()
  : field_tp(new sec_stp, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
///
fields::field_stp::
field_stp(const sec_ed& xcoordinates, const sec_stp& xproperty, bool xauto_access)
  : field_tp(new sec_stp, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
fields::field_stp&
fields::field_stp::
operator=(const field_stp& xother)
{
  // Preconditions:
...
fields::field_stp&
fields::field_stp::
operator=(const sec_stp& xsection)
{
  // Preconditions:
...
property() const
{
  ...
  sec_stp& result = dynamic_cast<sec_stp&>(*_property);
...
bool
fields::field_stp::
same_property_fiber_schema(const field_stp& xother, bool xauto_access) const
{
  bool result;
...
static_class_name()
{
  ...
  static const string result("field_stp");
...
is_ancestor_of(const any* xother) const
{
  ...
  bool result = dynamic_cast<const field_stp*>(xother) != 0;
...
fields::field_stp&
fields::
operator>>(const field_stp& xsrc, field_stp& xdst)
{
  // Preconditions:
...
#include "field_stp_funcs.impl.h"
