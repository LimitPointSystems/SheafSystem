...
//=============================================================================
// FIELD_VD FACET OF CLASS FIELD_MET_E3
//=============================================================================

///
fields::field_met_e3::
field_met_e3()
  : field_met_ed(new sec_met_e3, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
///
fields::field_met_e3::
field_met_e3(const sec_ed& xcoordinates, const sec_met_e3& xproperty, bool xauto_access)
  : field_met_ed(new sec_met_e3, new sec_ed_invertible, new base_space_member)
{
  // Preconditions:
...
field_met_e3(sec_met_e3* xproperty,
  ...
  : field_met_ed(xproperty, xcoordinates, xbase_space)
{
  // Preconditions:
...
fields::field_met_e3&
fields::field_met_e3::
operator=(const field_met_e3& xother)
{
  // Preconditions:
...
fields::field_met_e3&
fields::field_met_e3::
operator=(const sec_met_e3& xsection)
{
  // Preconditions:
...
property() const
{
  ...
  sec_met_e3& result = dynamic_cast<sec_met_e3&>(*_property);
...
bool
fields::field_met_e3::
same_property_fiber_schema(const field_met_e3& xother, bool xauto_access) const
{
  bool result;
...
//=============================================================================
// ANY FACET OF CLASS FIELD_MET_E3
//=============================================================================
...
static_class_name()
{
  ...
  static const string result("field_met_e3");
...
is_ancestor_of(const any* xother) const
{
  ...
  bool result = dynamic_cast<const field_met_e3*>(xother) != 0;
...
invariant() const
{
  ...
  if(invariant_check())
  {
    ...
    invariance(field_met_ed::invariant());
...
fields::field_met_e3&
fields::
operator>>(const field_met_e3& xsrc, field_met_e3& xdst)
{
  // Preconditions:
...
std::ostream&
fields::
operator<<(std::ostream& xos, const field_met_e3& xfield)
{
  // Preconditions:
