// $RCSfile: property_disc_iterator_4_3.h,v $ $Revision: 1.9 $ $Date: 2013/01/12 17:17:25 $
...
/// @file
/// Interface for class property_disc_iterator_4_3


#ifndef PROPERTY_DISC_ITERATOR_4_3_H
#define PROPERTY_DISC_ITERATOR_4_3_H
...
/// section and a property section with the discretization at or above the evaluation.
///
...
///
class SHEAF_DLL_SPEC property_disc_iterator_4_3 : public property_disc_iterator
{

  // ===========================================================
  /// @name PROPERTY_DISC_ITERATOR_4_3 FACET
  // ===========================================================
  //@{
...
private:
  ...
  ///
  property_disc_iterator_4_3(const property_disc_iterator_4_3& xother) {};
...
#endif // ifndef PROPERTY_DISC_ITERATOR_4_3_H
