...
#ifndef COM_LIMITPOINT_FIELDS_COPY_BASE_SPACE_MAP_PUSH_ACTION_H
#define COM_LIMITPOINT_FIELDS_COPY_BASE_SPACE_MAP_PUSH_ACTION_H
...
#endif // ifndef COM_LIMITPOINT_FIELDS_COPY_BASE_SPACE_MAP_PUSH_ACTION_H
