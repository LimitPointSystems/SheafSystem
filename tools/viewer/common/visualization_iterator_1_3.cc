// $RCSfile: visualization_iterator_1_3.cc,v $ $Revision: 1.27 $ $Date: 2013/01/12 17:17:57 $
//
// Copyright (c) 2013 Limit Point Systems, Inc.
//

// Implementation for class visualization_iterator_1_3
...
is_ancestor_of(const any* xother) const
{
  ...
  bool result = dynamic_cast<const visualization_iterator_1_3*>(xother) != 0;
...
clone() const
{
  ...
  visualization_iterator_1_3* cthis =
    const_cast<visualization_iterator_1_3*>(this);

  visualization_iterator_1_3* result =
    new visualization_iterator_1_3(cthis->coordinates_schema(),
...
next(bool xtruncate)
{
  ...
  while(!is_done())
  {
    if(action() == PREVISIT_ACTION)
    {
      ...
      // the coord disc is the vertices. The prop disc is at or
      // above the elements.
             ...
             vtkIdTypeArray* xvtk_cell_label_ids)
{
  ...
  /// @hack required because discretization_context::values
  ///       capacity is fixed at 3.
  ...
  // Transfer the property data and increment the cell seq id.
...
#ifdef DIAGNOSTIC_OUTPUT
  cout << "\tprop seq id: " << setw(6) << (_vis_state.eval_id - 1);
...
// ===========================================================
// VISUALIZATION_ITERATOR_1_3 FACET
// ===========================================================
...
tool::visualization_iterator_1_3::
visualization_iterator_1_3(const section_space_schema_member& xcoordinates_schema,
