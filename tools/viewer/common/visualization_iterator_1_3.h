// $RCSfile: visualization_iterator_1_3.h,v $ $Revision: 1.18 $ $Date: 2013/01/12 17:17:57 $

//
// Copyright (c) 2013 Limit Point Systems, Inc.
//

// Interface for class visualization_iterator_1_3


#ifndef VISUALIZATION_ITERATOR_1_3_H
#define VISUALIZATION_ITERATOR_1_3_H
...
///
/// A visualization iterator for a coordinate section with
/// discretization equal to vertices and property section
/// with evaluation at elements and discretization at or above
/// the elements.
///
...
///
class SHEAF_DLL_SPEC visualization_iterator_1_3 : public visualization_iterator
{
public:
  ...
  ///
  visualization_iterator_1_3(const section_space_schema_member& xcoordinate_schema,
...
private:
  ...
  ///
  visualization_iterator_1_3(const visualization_iterator_1_3& xother) {};

};
  
} // namespace tool

#endif // ifndef VISUALIZATION_ITERATOR_1_3_H
