...
#
set(${COMPONENT}_JAVA_BINDING_LIBS ${SHEAVES_JAVA_BINDING_LIBS} ${${COMPONENT}_JAVA_BINDING_LIB}  CACHE STRING " Cumulative Java binding libraries for ${PROJECT_NAME}" FORCE)

#
# Set the cumulative Java binding jar variable for this component.
#
set(${COMPONENT}_JAVA_BINDING_JARS ${SHEAVES_JAVA_BINDING_JARS} ${PROJECT_NAME}_java_binding.jar CACHE STRING "Cumulative Java bindings jars for ${PROJECT_NAME}")

#
# Set the cumulative Python binding library var for this component.
#
set(${COMPONENT}_PYTHON_BINDING_LIBS ${SHEAVES_PYTHON_BINDING_LIBS} ${${COMPONENT}_PYTHON_BINDING_LIB}  CACHE STRING " Cumulative Python binding libraries for ${PROJECT_NAME}" FORCE)
      
#
# Set the cumulative include path for this component.
#
set(${COMPONENT}_IPATHS ${SHEAVES_IPATHS} ${${COMPONENT}_IPATH}  CACHE STRING " Cumulative include paths for ${PROJECT_NAME}" FORCE)
...
function(add_bindings_targets)
    ...
    if(SWIG_FOUND AND BUILD_BINDINGS)  
        ...
        if(WIN64INTEL OR WIN64MSVC)
            ...
            target_link_libraries(${${COMPONENT}_CSHARP_BINDING_LIB} ${SHEAVES_CSHARP_BINDING_LIB} ${${COMPONENT}_SHARED_LIB})
        endif()    
        ...
        if(WIN64INTEL OR WIN64MSVC)
            ...
            target_link_libraries(${${COMPONENT}_PYTHON_BINDING_LIB} ${SHEAVES_PYTHON_BINDING_LIBS} debug ${${COMPONENT}_DEBUG_IMPORT_LIB} optimized ${${COMPONENT}_IMPORT_LIB} ${PYTHON_LIBRARY} ${PYTHON_DEBUG_LIBRARY})
