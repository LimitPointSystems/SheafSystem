...
if(WIN64INTEL OR WIN64MSVC)
    ...
    #
    set(${COMPONENT}_STATIC_LIBS ${SHEAVES_STATIC_LIBS} 
    ...
    # Set the cumulative shared library var for this component.
    #
    set(${COMPONENT}_SHARED_LIBS ${SHEAVES_SHARED_LIBS} 
...
#
set(${COMPONENT}_JAVA_BINDING_LIBS ${SHEAVES_JAVA_BINDING_LIBS} 
...
#
set(${COMPONENT}_JAVA_BINDING_JARS ${SHEAVES_JAVA_BINDING_JARS} 
...
#
set(${COMPONENT}_PYTHON_BINDING_LIBS ${SHEAVES_PYTHON_BINDING_LIBS} 
...
#
set(${COMPONENT}_IPATHS ${SHEAVES_IPATHS} ${${COMPONENT}_IPATH} 
...
if(SWIG_FOUND AND BUILD_BINDINGS)  
    ...
    if(WIN64INTEL OR WIN64MSVC)
    message(STATUS "${SHEAVES_CLASSPATH}")
