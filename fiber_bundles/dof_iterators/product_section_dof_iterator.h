// $RCSfile: product_section_dof_iterator.h,v $ $Revision: 1.2 $ $Date: 2013/01/10 13:54:23 $
...
#ifndef PRODUCT_SECTION_DOF_ITERATOR_H
#define PRODUCT_SECTION_DOF_ITERATOR_H
...
#endif // ifndef PRODUCT_SECTION_DOF_ITERATOR_H
