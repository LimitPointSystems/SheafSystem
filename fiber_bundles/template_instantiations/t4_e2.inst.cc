...
// $RCSfile: t4_e2.inst.cc,v $ $Revision: 1.3 $ $Date: 2013/01/12 17:17:18 $
...
//template class
//SHEAF_DLL_SPEC
//fiber_bundle::t4_e2_row_dofs_type<float>;

//template
//SHEAF_DLL_SPEC
//ostream& fiber_bundle::operator<<(
//    ostream&, const fiber_bundle::t4_e2_row_dofs_type<float>&);
