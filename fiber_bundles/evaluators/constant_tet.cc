// $RCSfile: constant_tet.cc,v $ $Revision: 1.19 $ $Date: 2013/03/20 21:56:05 $
//
// Copyright (c) 2013 Limit Point Systems, Inc.
//

// Implementation for class constant_tet
...
///
fiber_bundle::constant_tet::value_type
fiber_bundle::constant_tet::
       ...
       size_type xdf)
{
  ...
  /// @todo Implement const_tet::volume.
...
fiber_bundle::constant_tet&
fiber_bundle::constant_tet::
operator=(const constant_tet& xother)
{
...
is_ancestor_of(const any* xother) const
{
  ...
  bool result = dynamic_cast<const constant_tet*>(xother) != 0;
