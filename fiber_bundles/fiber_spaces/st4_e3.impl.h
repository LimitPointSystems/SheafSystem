...
// $RCSfile: st4_e3.impl.h,v $ $Revision: 1.9 $ $Date: 2013/01/12 17:17:02 $
...
static_class_name()
{
  ...
  static const string result("st4_e3_row_dofs_type");
...
template <typename T>
ostream& operator<<(ostream& xos, const st4_e3_row_dofs_type<T>& xrdt)
{
  int ld = xrdt.d();
  for(int i=0; i<ld; ++i)
  {
