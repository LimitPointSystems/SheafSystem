         ...
         bool xauto_access)
{
  ...
  ensure(xns.member_poset<host_type>(xhost_path, xauto_access).factor_ct(true) == 81);
  ensure(xns.member_poset<host_type>(xhost_path, xauto_access).d(true) == 81);
...
new_host(namespace_type& xns, const string& xsuffix, bool xauto_access)
{
  ...
  ensure(xns.member_poset<host_type>(result, xauto_access).factor_ct(true) == 81);
  ensure(xns.member_poset<host_type>(result, xauto_access).d(true) == 81);
