...
// ===========================================================
// HOST FACTORY FACET OF CLASS E2
// ===========================================================
...
new_host(namespace_type& xns, 
         ...
         bool xauto_access)
{
  // cout << endl << "Entering e2::new_host." << endl;
  ...
  require(schema_poset_member::row_dof_ct(xns, xschema_path, xauto_access) == 2);
  ...
  ensure(xns.member_poset<host_type>(xhost_path, xauto_access).factor_ct(true) == 2);
  ensure(xns.member_poset<host_type>(xhost_path, xauto_access).d(true) == 2);
  ...
  ensure(xns.member_poset<host_type>(xhost_path, xauto_access).dd(true) == 2);
  ensure(xns.member_poset<host_type>(xhost_path, xauto_access).vector_space_path(true) == xhost_path );

  // Exit:

  // cout << "Leaving e2::new_host." << endl;
  return;
}
...
new_host(namespace_type& xns, const string& xsuffix, bool xauto_access)
{
  ...
  ensure(xns.member_poset<host_type>(result, xauto_access).factor_ct(true) == 2);
  ensure(xns.member_poset<host_type>(result, xauto_access).d(true) == 2);
  ...
  ensure(xns.member_poset<host_type>(result, xauto_access).dd(true) == 2);
