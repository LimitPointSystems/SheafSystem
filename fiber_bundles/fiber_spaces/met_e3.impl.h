...
// $RCSfile: met_e3.impl.h,v $ $Revision: 1.10 $ $Date: 2013/01/12 17:17:02 $
...
#ifndef MET_E3_IMPL_H
#define MET_E3_IMPL_H
...
static_class_name()
{
  ...
  static const string result("met_e3_row_dofs_type");
