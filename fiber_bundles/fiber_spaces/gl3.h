...
// $RCSfile: gl3.h,v $ $Revision: 1.38 $ $Date: 2013/03/13 00:58:43 $
...
public:
  ...
  ///
  gl3(const poset* xhost, const string& xname);
...
///
SHEAF_DLL_SPEC ostream& operator<<(ostream& xos, const gl3_lite& xlite);

///
/// Insert gl3& xpersistent into ostream& xos.
///
SHEAF_DLL_SPEC ostream& operator<<(ostream& xos, const gl3& xpersistent);
