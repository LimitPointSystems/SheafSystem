          ...
          bool xauto_access)
{
  ...
  ensure(xns.member_poset<stp_space>(xpath, xauto_access).factor_ct(true) == xns.member_poset<stp_space>(xpath, xauto_access).d(true));
  ensure(xns.member_poset<stp_space>(xpath, xauto_access).d(true) == schema_poset_member::row_dof_ct(xns, xschema_path, xauto_access));
  ensure(xns.member_poset<stp_space>(xpath, xauto_access).p(true) == p(xns, xschema_path, xvector_space_path, xauto_access));
  ensure(xns.member_poset<stp_space>(xpath, xauto_access).vector_space_path(true) == xvector_space_path );
