...
/// @file
/// Interface for class ij_adjacency_index_space_interval

#ifndef IJ_ADJACENCY_INDEX_SPACE_INTERVAL_H
#define IJ_ADJACENCY_INDEX_SPACE_INTERVAL_H
...
/// id spaces for the adjacency of a 2-dimensional structured block.
///
class SHEAF_DLL_SPEC ij_adjacency_index_space_interval : public index_space_interval
{
...
public:
  ...
  ///
  /// Create a new interval of id spaces for 2D structured block adjacency
  /// in the id space family xid_spaces with upper bound xub,
  /// zone hub begin, the number of zones in the i-direction xi_size,
  /// and the number of zones in the j-direction xj_size.
  /// Return a reference to the id space interval.
  ///
  static const ij_adjacency_index_space_interval& new_space(index_space_family& xid_spaces,
							    size_type xub,
...
private:
  ...
  // ===========================================================
  /// @name IJ_ADJACENCY_INDEX_SPACE_INTERVAL FACET
  // ===========================================================
  //@{
...
public:
  ...
  /// Destructor
  ///
  virtual ~ij_adjacency_index_space_interval();
  ...
  ///
  /// Compute the hub id of the fist adjacent zone and the number of adjacent
  /// zones in each direction for id space with id xlocal_id.
  ///
  void adjacent_zones(pod_type xlocal_id,
		      pod_type& xzone_hub_begin,
		      size_type& xi_ct,
...
public:
  ...
  ///
  virtual ij_adjacency_index_space_interval* clone(const arg_list& xargs) const;
...
protected:
  ...
  /// The iterator pool.
  ///
  mutable list_pool<ij_adjacency_implicit_index_space_iterator> _iterators;
...
///
SHEAF_DLL_SPEC 
size_t deep_size(const ij_adjacency_index_space_interval& xn, bool xinclude_shallow = true);
  
} // end namespace fiber_bundle

#endif // ifndef IJ_ADJACENCY_INDEX_SPACE_INTERVAL_H
