// $RCSfile: ij_connectivity_index_space_interval.h,v $ $Revision: 1.3 $ $Date: 2013/03/13 00:58:48 $
...
public:
  ...
  ///
  virtual ij_connectivity_index_space_interval* clone(const arg_list& xargs) const;
