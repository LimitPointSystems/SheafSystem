...
#ifndef IJK_ADJACENCY_INDEX_SPACE_INTERVAL_H
...
public:
  ...
  ///
  virtual ijk_adjacency_index_space_interval* clone(const arg_list& xargs) const;
...
#endif // ifndef IJK_ADJACENCY_INDEX_SPACE_INTERVAL_H
