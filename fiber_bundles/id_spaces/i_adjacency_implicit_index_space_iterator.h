// $RCSfile: i_adjacency_implicit_index_space_iterator.h,v $ $Revision: 1.3 $ $Date: 2013/01/15 22:23:43 $
...
/// @file
/// Interface for class i_adjacency_implicit_index_space_iterator

#ifndef I_ADJACENCY_IMPLICIT_INDEX_SPACE_ITERATOR_H
#define I_ADJACENCY_IMPLICIT_INDEX_SPACE_ITERATOR_H
...
/// space in an i_adjacency_index_space_interval.
///
class SHEAF_DLL_SPEC i_adjacency_implicit_index_space_iterator : public implicit_index_space_iterator
{

  friend class i_adjacency_implicit_index_space_interval;

  // ===========================================================
  /// @name I_ADJACENCY_IMPLICIT_INDEX_SPACE_ITERATOR FACET
  // ===========================================================
  //@{
...
public:
  ...
  /// Assignment operator.
  ///
  virtual i_adjacency_implicit_index_space_iterator& operator=(const index_space_iterator& xother);
...
#endif // ifndef I_ADJACENCY_IMPLICIT_INDEX_SPACE_ITERATOR_H
