...
// $RCSfile: sec_at2_e3.h,v $ $Revision: 1.23 $ $Date: 2013/03/13 00:58:49 $
...
class SHEAF_DLL_SPEC sec_at2_e3 : public sec_at2
{
  ...
  //============================================================================
  /// @name AT2_E3 FACET OF CLASS SEC_AT2_E3
  //============================================================================
  //@{
...
public:
  ...
  ///
  sec_at2_e3(const sec_rep_space* xhost, const string& xname);
