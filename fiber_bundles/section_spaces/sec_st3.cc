...
new_host(namespace_type& xns, 
         ...
         bool xauto_access)
{
  // cout << endl << "Entering sec_st3::new_host." << endl;
  ...
  // cout << "Leaving sec_st3::new_host." << endl;
  return result;
}
...
fiber_bundle::sec_st3::
sec_st3(const sec_rep_space* xhost, const string& xname)
{
...
fiber_bundle::sec_st3::
sec_st3(const sec_rep_space_member* xother)
{
...
fiber_bundle::sec_st3::
sec_st3(sec_rep_space* xhost, section_dof_map* xdof_map, bool xauto_access)
{
...
const fiber_bundle::sec_st3::fiber_type&
fiber_bundle::sec_st3::
...
//==============================================================================
// ABSTRACT POSET MEMBER FACET OF CLASS SEC_ST3
//==============================================================================
...
static_class_name()
{
  ...
  static const string result("sec_st3");
...
is_ancestor_of(const any* xother) const
{
  ...
  bool result = dynamic_cast<const sec_st3*>(xother) != 0;
