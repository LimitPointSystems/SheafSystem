...
// ===========================================================
// HOST FACTORY FACET OF CLASS SEC_T4
// ===========================================================
...
new_host(namespace_type& xns, 
         ...
         bool xauto_access)
{
  // cout << endl << "Entering sec_t4::new_host." << endl;
  ...
  // cout << "Leaving sec_t4::new_host." << endl;
  return result;
}
...
fiber_bundle::sec_t4::
sec_t4(const sec_rep_space* xhost, const std::string& xname)
{
...
fiber_bundle::sec_t4::
sec_t4(sec_rep_space_member* xother)
{
...
fiber_bundle::sec_t4::
sec_t4(sec_rep_space* xhost, section_dof_map* xdof_map, bool xauto_access)
{
...
const fiber_bundle::sec_t4::fiber_type&
fiber_bundle::sec_t4::
...
//==============================================================================
// ABSTRACT POSET MEMBER FACET OF CLASS SEC_T4
//==============================================================================
...
static_class_name()
{
  ...
  static const string result("sec_t4");
...
is_ancestor_of(const any* xother) const
{
  ...
  bool result = dynamic_cast<const sec_t4*>(xother) != 0;
