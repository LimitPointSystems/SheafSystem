...
// $RCSfile: sec_st4.cc,v $ $Revision: 1.19 $ $Date: 2013/03/13 00:58:50 $
...
fiber_bundle::sec_st4::
sec_st4(const sec_rep_space_member* xother)
{
...
fiber_bundle::sec_st4::
sec_st4(sec_rep_space* xhost, section_dof_map* xdof_map, bool xauto_access)
{
...
fiber_bundle::sec_st4&
fiber_bundle::sec_st4::
operator=(const st4_lite& xfiber)
{
  // Preconditions:
...
const fiber_bundle::sec_st4::fiber_type&
fiber_bundle::sec_st4::
...
//==============================================================================
// ABSTRACT POSET MEMBER FACET OF CLASS SEC_ST4
//==============================================================================
...
static_class_name()
{
  ...
  static const string result("sec_st4");
...
is_ancestor_of(const any* xother) const
{
  ...
  bool result = dynamic_cast<const sec_st4*>(xother) != 0;
...
invariant() const
{
  ...
  if (invariant_check())
  {
    ...
    invariance(is_attached() ? p() == 4 : true);
