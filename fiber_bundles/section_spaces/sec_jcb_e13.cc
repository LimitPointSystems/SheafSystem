         ...
         bool xauto_access)
{
  ...
  // cout << "Leaving sec_jcb_e13::new_host." << endl;
  return result;
}
              ...
              bool xauto_access)
{
  ...
  require(standard_host_is_available<sec_jcb_e13>(xns, xbase_path, xrep_path, xsection_suffix, xfiber_suffix, xauto_access));
  require(fiber_type::standard_host_is_available<fiber_type>(xns, xfiber_suffix, xauto_access));
  require(schema_type::standard_host_is_available<sec_jcb_e13>(xns, xbase_path, xrep_path, xfiber_suffix, xauto_access));

  // Body:

  poset_path lstd_path = standard_host_path<sec_jcb_e13>(xbase_path, xrep_path, xsection_suffix, xfiber_suffix);
  ...
  else
  {
    ...
    poset_path lstd_schema_path = 
      schema_type::standard_member<sec_jcb_e13>(xns, xbase_path, lrep_path, xfiber_suffix, xauto_access);
  ...
  ensure(result.path(true) == standard_host_path<sec_jcb_e13>(xbase_path, xrep_path, xsection_suffix, xfiber_suffix));
  ensure(result.state_is_not_read_accessible());
  ensure(result.schema(true).path(xauto_access) == 
         schema_type::standard_member_path<sec_jcb_e13>(xbase_path, xrep_path, xfiber_suffix));
...
//==============================================================================
// JCB_E13 FACET OF CLASS SEC_JCB_E13
//==============================================================================
...
fiber_bundle::sec_jcb_e13::
sec_jcb_e13(const sec_rep_space_member* xother)
{
...
fiber_bundle::sec_jcb_e13::
sec_jcb_e13(sec_rep_space* xhost, section_dof_map* xdof_map, bool xauto_access)
{
...
fiber_bundle::sec_jcb_e13&
fiber_bundle::sec_jcb_e13::
operator=(const sec_jcb_e13& xother)
{
  // Preconditions:
...
fiber_bundle::sec_jcb_e13&
fiber_bundle::sec_jcb_e13::
operator=(const jcb_e13_lite& xfiber)
{
  // Preconditions:
...
const fiber_bundle::sec_jcb_e13::fiber_type&
fiber_bundle::sec_jcb_e13::
...
//==============================================================================
// JCB_ED FACET OF CLASS SEC_JCB_E13
//==============================================================================
...
//==============================================================================
// JCB FACET OF CLASS SEC_JCB_E13
//==============================================================================
...
//==============================================================================
// TUPLE FACET OF CLASS SEC_JCB_E13
//==============================================================================
...
//==============================================================================
// ABSTRACT POSET MEMBER FACET OF CLASS SEC_JCB_E13
//==============================================================================
...
static_class_name()
{
  ...
  static const string result("sec_jcb_e13");
...
clone() const
{
  ...
  sec_jcb_e13 *result = new sec_jcb_e13();
...
//==============================================================================
// ANY FACET OF CLASS SEC_JCB_E13
//==============================================================================
...
is_ancestor_of(const any* xother) const
{
  ...
  bool result = dynamic_cast<const sec_jcb_e13*>(xother) != 0;
...
{
public:
  void operator()(const jcb_e13_lite& x0, const e1_lite& x1,
...
{
public:
  void operator()(const jcb_e13_lite& x0, const e3_lite& x1,
...
push(const sec_jcb_e13& xjcb, const sec_e1& xvector, sec_e3& xresult,
     bool xauto_access)
{
  // Preconditions:
...
void
fiber_bundle::sec_jcb_algebra::
pull(const sec_jcb_e13& xjcb, const sec_e3& xcovector, sec_e1& xresult,
     bool xauto_access)
{
 // Preconditions:
