...
// $RCSfile: general_matrix_3x2.impl.h,v $ $Revision: 1.10 $ $Date: 2013/01/12 17:17:09 $
...
operator T* ()
{
  ...
  cout << "general_matrix_3x2<T>::operator T* () " << endl;
...
operator const T* () const
{
  ...
  cout << "general_matrix_3x2<T>::operator const T* () const " << endl;
