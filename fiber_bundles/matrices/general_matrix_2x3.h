...
// $RCSfile: general_matrix_2x3.h,v $ $Revision: 1.9 $ $Date: 2013/01/12 17:17:09 $

//
// Copyright (c) 2013 Limit Point Systems, Inc. 
//

// Interface for general_matrix_2x3 classes.

#ifndef GENERAL_MATRIX_2X3_H
#define GENERAL_MATRIX_2X3_H
...
///
/// Class general_matrix_2x3 is a special kind of matrix class intended to be
...
public:
  ...
  ///
  //void adjoint(general_matrix_2x3<T>& xresult) const;

  ///
  /// The adjoint of the matrix (auto-allocated).
  ///
  //general_matrix_2x3<T> adjoint() const;
  ...
  ///
  general_matrix_2x3<T> multiply(const T& xscalar) const;
  ...
  ///
  general_matrix_2x1<T> multiply(const general_matrix_3x1<T>& xother) const;
  ...
  /// Premultiply matrix xother by this matrix (auto-allocated).
  ///
  general_matrix_2x2<T> multiply(const general_matrix_3x2<T>& xother) const;
  ...
  /// Premultiply matrix xother by this matrix (auto-allocated).
  ///
  general_matrix_2x3<T> multiply(const general_matrix_3x3<T>& xother) const;

  ///
  /// The transpose of the matrix (pre-allocated).
  ///
  void transpose(general_matrix_3x2<T>& xresult) const;
...
#endif // ifndef GENERAL_MATRIX_2X3_H
