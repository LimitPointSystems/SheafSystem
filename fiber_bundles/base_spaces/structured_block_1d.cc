...
static_prototype_path()
{
  ...
  STATIC_PROTOTYPE_PATH(base_space_member::prototypes_poset_name(), "structured_block_1d");
...
{
  // cout << endl << "Entering structured_block_1d::standard_host." << endl;
  ...
  // cout << "Leaving structured_block_1d::standard_host." << endl;
  return result;
}
