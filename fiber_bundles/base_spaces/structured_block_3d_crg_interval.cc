// $RCSfile: structured_block_3d_crg_interval.cc,v $ $Revision: 1.3 $ $Date: 2013/03/13 00:58:41 $
...
/// @file
/// Implementation for class structured_block_3d_crg_interval.
...
initialize_upper_covers()
{
  ...
  largs = ijk_adjacency_index_space_interval::make_arg_list(_zone_begin,
							    _i_size,
							    _j_size,
							    _k_size);

  _adjacency_begin =
    _id_spaces->new_secondary_interval("ijk_adjacency_index_space_interval",
				       largs, _vertex_size);
