// $RCSfile: triangle_connectivity.h,v $ $Revision: 1.18 $ $Date: 2013/01/12 17:16:53 $
...
///
/// Cnnectivity for a triangle mesh with the elements arranged
/// so the vertices form a regular rectangular array.
///
