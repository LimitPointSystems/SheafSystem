// $RCSfile: structured_block_3d_crg_range.h,v $ $Revision: 1.17 $ $Date: 2013/01/14 16:03:37 $
...
/// @file
/// Interface for class structured_block_3d_crg_range
///
...
#ifndef STRUCTURED_BLOCK_3D_CRG_RANGE_H
#define STRUCTURED_BLOCK_3D_CRG_RANGE_H
...
class structured_block_3d_crg_range;

///
/// Insert structured_block_3d_crg_range& m into ostream& os.
///
SHEAF_DLL_SPEC ostream& operator <<(ostream& os, const fiber_bundle::structured_block_3d_crg_range& m);

SHEAF_DLL_SPEC size_t deep_size(const structured_block_3d_crg_range& m);
...
///
class SHEAF_DLL_SPEC structured_block_3d_crg_range : public homogeneous_block_crg_range
{

  friend SHEAF_DLL_SPEC ostream& operator <<(ostream& os, const structured_block_3d_crg_range& m);
  friend SHEAF_DLL_SPEC size_t deep_size(const structured_block_3d_crg_range& m);

  // ===========================================================
  /// @name STRUCTURED_BLOCK_3D_CRG_RANGE FACET
  // ===========================================================
  //@{
...
public:
  ...
  /// Destructor
  ///
  virtual ~structured_block_3d_crg_range();
...
public:
  ...
  ///
  const ijk_product_structure& zone_product_structure() const;
...
public:
  ...
  ///
  const ijk_product_structure& vertex_product_structure() const;
...
public:
  ...
  ///
  virtual structured_block_3d_crg_range* clone() const;
...
///
/// The deep size of the referenced object of type structured_block_3d_crg_range.
/// if xinclude_shallow, add the sizeof xpath to the result.
///
size_t
SHEAF_DLL_SPEC
deep_size(const structured_block_3d_crg_range& xr, bool xinclude_shallow = true);

 
} // namespace fiber_bundle

#endif // ifndef STRUCTURED_BLOCK_3D_CRG_RANGE_H
