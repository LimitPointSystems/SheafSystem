...
#define COM_LIMITPOINT_SHEAF_PRIMARY_INDEX_SPACE_HANDLE_H
...
public:
  ...
  /// synonym for attach_to(xother).
  ///
  virtual primary_index_space_handle& operator=(const index_space_handle& xother);
...
#endif // ifndef COM_LIMITPOINT_SHEAF_PRIMARY_INDEX_SPACE_HANDLE_H
