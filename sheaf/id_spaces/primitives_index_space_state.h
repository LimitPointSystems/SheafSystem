...
#ifndef COM_LIMITPOINT_SHEAF_PRIMITIVES_INDEX_SPACE_STATE_H
#define COM_LIMITPOINT_SHEAF_PRIMITIVES_INDEX_SPACE_STATE_H
...
#endif // ifndef COM_LIMITPOINT_SHEAF_PRIMITIVES_INDEX_SPACE_STATE_H
