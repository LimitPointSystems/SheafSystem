...
#ifndef COM_LIMITPOINT_SHEAF_HASH_INDEX_SPACE_STATE_H
#define COM_LIMITPOINT_SHEAF_HASH_INDEX_SPACE_STATE_H
...
private:
  ...
  /// The handle pool.
  ///
  static list_pool<hash_index_space_handle>& handles();
