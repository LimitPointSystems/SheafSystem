...
#ifndef COM_LIMITPOINT_SHEAF_SUM_INDEX_SPACE_HANDLE_H
#define COM_LIMITPOINT_SHEAF_SUM_INDEX_SPACE_HANDLE_H
...
public:
  ...
  /// synonym for attach_to(xother).
  ///
  virtual sum_index_space_handle& operator=(const index_space_handle& xother);
...
#endif // ifndef COM_LIMITPOINT_SHEAF_SUM_INDEX_SPACE_HANDLE_H
