...
#ifndef COM_LIMITPOINT_SHEAF_PRIMITIVES_INDEX_SPACE_HANDLE_H
#define COM_LIMITPOINT_SHEAF_PRIMITIVES_INDEX_SPACE_HANDLE_H
...
#endif // ifndef COM_LIMITPOINT_SHEAF_PRIMITIVES_INDEX_SPACE_HANDLE_H
