...
#ifndef COM_LIMITPOINT_SHEAF_HASH_INDEX_SPACE_HANDLE_H
#define COM_LIMITPOINT_SHEAF_HASH_INDEX_SPACE_HANDLE_H
...
///
/// An hash map implementation of class mutable_index_space_handle.
...
///
class SHEAF_DLL_SPEC hash_index_space_handle : public mutable_index_space_handle
{
...
public:
  ...
  ///
  /// Create a new hash id space in the id space family xid_space
  /// with name xname, persistence xis_persistent, and capacity xcapacity..
  /// Returns a handle to the id space created.
  ///
  static hash_index_space_handle new_space(index_space_family& xid_spaces,
...
private:
  ...
  // ===========================================================
  /// @name HASH_INDEX_SPACE_HANDLE FACET
  // ===========================================================
  //@{
...
protected:
  ...
  ///
  const hash_index_space_state& state() const;
...
#endif // ifndef HASH_INDEX_SPACE_HANDLE_H
