...
#ifndef COM_LIMITPOINT_SHEAF_NAMESPACE_POSET_MEMBER_H
#define COM_LIMITPOINT_SHEAF_NAMESPACE_POSET_MEMBER_H
...
#endif // COM_LIMITPOINT_SHEAF_NAMESPACE_POSET_MEMBER_H
