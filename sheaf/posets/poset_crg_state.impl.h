...
#ifndef COM_LIMITPOINT_SHEAF_POSET_CRG_STATE_IMPL_H
#define COM_LIMITPOINT_SHEAF_POSET_CRG_STATE_IMPL_H
...
#endif // ifndef COM_LIMITPOINT_SHEAF_POSET_CRG_STATE_IMPL_H
