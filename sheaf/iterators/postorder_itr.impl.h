...
#ifndef COM_LIMITPOINT_SHEAF_POSTORDER_ITR_IMPL_H
#define COM_LIMITPOINT_SHEAF_POSTORDER_ITR_IMPL_H
...
#endif // ifndef COM_LIMITPOINT_SHEAF_POSTORDER_ITR_IMPL_H
