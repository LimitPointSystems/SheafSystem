...
#ifndef COM_LIMITPOINT_SHEAF_FILTERED_DEPTH_FIRST_ITR_IMPL_H
#define COM_LIMITPOINT_SHEAF_FILTERED_DEPTH_FIRST_ITR_IMPL_H
...
#endif // ifndef COM_LIMITPOINT_SHEAF_FILTERED_DEPTH_FIRST_ITR_IMPL_H
