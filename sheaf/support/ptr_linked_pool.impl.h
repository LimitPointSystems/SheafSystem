...
#ifndef COM_LIMITPOINT_SHEAF_PTR_LINKED_POOL_IMPL_H
#define COM_LIMITPOINT_SHEAF_PTR_LINKED_POOL_IMPL_H
...
print(std::ostream& xos) const
{
  ...
  typename singly_linked_list<block<T>*>::const_iterator citr;
...
#endif // ifndef COM_LIMITPOINT_SHEAF_PTR_LINKED_POOL_IMPL_H
