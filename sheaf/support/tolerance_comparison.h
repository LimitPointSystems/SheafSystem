...
#ifndef COM_LIMITPOINT_SHEAF_TOLERANCE_COMPARISON_H
#define COM_LIMITPOINT_SHEAF_TOLERANCE_COMPARISON_H
...
#endif // ifndef COM_LIMITPOINT_SHEAF_TOLERANCE_COMPARISON_H
